...
function toCamelCase(object) {
  return lodash.transform(object, function (acc, value, key, target) {
    var newKey = lodash.isArray(target) || key.indexOf('_') === -1 ? key : lodash.camelCase(key);
    acc[newKey] = lodash.isObject(value) ? toCamelCase(value) : value;
  });
}

function toSnakeCase(object) {
  return lodash.transform(object, function (acc, value, key, target) {
    var newKey = lodash.isArray(target) ? key : lodash.snakeCase(key);
    acc[newKey] = lodash.isObject(value) ? toSnakeCase(value) : value;
  });
}

function toSafeNumber(object) {
  return lodash.transform(object, function (acc, value, key) {
    if (value instanceof BigNumber__default["default"] && value.isInteger() && value.isLessThanOrEqualTo(Number.MAX_SAFE_INTEGER)) {
...
var Message = /*#__PURE__*/function () {
  function Message(options) {
    ...
    var command = options.command,
        ...
        requestId = _options$requestId === void 0 ? cryptoBrowserify.randomBytes(32).toString('hex') : _options$requestId;
  ...
  _createClass__default["default"](Message, [{
    ...
    value: function toJSON(useSnakeCase) {
      ...
      return JSONbig__default["default"].stringify(formatedData);
    }
  }], [{
    key: "fromJSON",
    value: function fromJSON(json, useCamelCase) {
      var _toSafeNumber = toSafeNumber(JSONbig__default["default"].parse(json)),
...
var Service = /*#__PURE__*/function (_EventEmitter) {
  _inherits__default["default"](Service, _EventEmitter);
  ...
  function Service(name, client) {
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "handleMessage", function (message) {
    ...
    if (!skipAddService) {
      client.addService(_assertThisInitialized__default["default"](_this));
    }
        ...
        return _regeneratorRuntime__default["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                setTimeout( /*#__PURE__*/_asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee() {
  ...
  _createClass__default["default"](Service, [{
    key: "whenReady",
    value: function () {
      var _whenReady = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee3(callback) {
    ...
    key: "command",
    value: function () {
      var _command2 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee4(_command) {
        var data,
            ack,
            timeout,
            disableFormat,
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 7:
                ...
                updatedData = lodash.omitBy(data, lodash.isUndefined);
                _context4.next = 10;
    ...
    key: "ping",
    value: function () {
      var _ping = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee5() {
...
var Daemon = /*#__PURE__*/function (_Service) {
  _inherits__default["default"](Daemon, _Service);

  var _super = _createSuper$d(Daemon);

  function Daemon(client, options) {
    _classCallCheck__default["default"](this, Daemon);
  ...
  _createClass__default["default"](Daemon, [{
    key: "registerService",
...
var ErrorData = /*#__PURE__*/function (_Error) {
  _inherits__default["default"](ErrorData, _Error);
  ...
  function ErrorData(message, data) {
    ...
    _classCallCheck__default["default"](this, ErrorData);
  ...
  return _createClass__default["default"](ErrorData);
...
var log = debug__default["default"]('chia-api:client');
...
var Client = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Client(options) {
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "connected", false);

    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "requests", new Map());

    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "services", new Set());

    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "started", new Set());

    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "connectedPromise", null);

    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "closed", false);

    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "state", ConnectionState$1.DISCONNECTED);

    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "reconnectAttempt", 0);

    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "handleOpen", /*#__PURE__*/_asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee() {
      return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "handleError", /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2(error) {
        return _regeneratorRuntime__default["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "handleMessage", function (data) {
    ...
    _this.daemon = new Daemon(_assertThisInitialized__default["default"](_this));
  ...
  _createClass__default["default"](Client, [{
    ...
    key: "connect",
    value: function () {
      var _connect = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee3(reconnect) {
        var _this3 = this;
    ...
    key: "startService",
    value: function () {
      var _startService = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee4(serviceName, disableWait) {
    ...
    key: "startServices",
    value: function () {
      var _startServices = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee6() {
        var _this4 = this;
            ...
            switch (_context6.prev = _context6.next) {
              ...
              case 2:
                ...
                return Promise.all(services.map( /*#__PURE__*/function () {
                  var _ref3 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee5(serviceName) {
                    return _regeneratorRuntime__default["default"].wrap(function _callee5$(_context5) {
                      while (1) {
                        switch (_context5.prev = _context5.next) {
                          case 0:
    ...
    key: "stopService",
    value: function () {
      var _stopService = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee7(serviceName) {
    ...
    key: "send",
    value: function () {
      var _send = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee8(message, timeout, disableFormat) {
        var _this5 = this;
    ...
    key: "close",
    value: function () {
      var _close = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee10(force) {
        var _this6 = this;
            ...
            switch (_context10.prev = _context10.next) {
              ...
              case 3:
                ...
                return Promise.all(Array.from(this.started).map( /*#__PURE__*/function () {
                  var _ref4 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee9(serviceName) {
...
var Events = /*#__PURE__*/function (_Service) {
  _inherits__default["default"](Events, _Service);
  ...
  return _createClass__default["default"](Events);
}(Service);
...
var Farmer = /*#__PURE__*/function (_Service) {
  _inherits__default["default"](Farmer, _Service);
  ...
  function Farmer(client, options) {
    ...
    _classCallCheck__default["default"](this, Farmer);

    _this = _super.call(this, ServiceName$1.FARMER, client, options, /*#__PURE__*/_asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee() {
      return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this.onNewFarmingInfo(function (data) {
                ...
                if (farmingInfo) {
                  _this.farmingInfo = [farmingInfo].concat(_toConsumableArray__default["default"](_this.farmingInfo)).slice(0, FARMING_INFO_MAX_ITEMS);
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "farmingInfo", []);

    return _this;
  }

  _createClass__default["default"](Farmer, [{
    key: "getFarmingInfo",
    value: function () {
      var _getFarmingInfo = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2() {
        return _regeneratorRuntime__default["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    value: function () {
      var _getRewardTargets = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee3(searchForPrivateKey) {
        return _regeneratorRuntime__default["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    value: function () {
      var _setRewardTargets = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee4(farmerTarget, poolTarget) {
        return _regeneratorRuntime__default["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
    ...
    value: function () {
      var _getSignagePoints = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee5() {
        return _regeneratorRuntime__default["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
    ...
    key: "getConnections",
    value: function () {
      var _getConnections = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee6() {
        return _regeneratorRuntime__default["default"].wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
    ...
    key: "openConnection",
    value: function () {
      var _openConnection = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee7(host, port) {
        return _regeneratorRuntime__default["default"].wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
    ...
    key: "closeConnection",
    value: function () {
      var _closeConnection = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee8(nodeId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
    ...
    key: "getPoolState",
    value: function () {
      var _getPoolState = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee9() {
        return _regeneratorRuntime__default["default"].wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
    ...
    value: function () {
      var _setPayoutInstructions = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee10(launcherId, payoutInstructions) {
        return _regeneratorRuntime__default["default"].wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
    ...
    key: "getHarvesters",
    value: function () {
      var _getHarvesters = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee11() {
    ...
    value: function () {
      var _getHarvesterPlotsValid = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee12(nodeId) {
        var page,
            pageSize,
            _args12 = arguments;
    ...
    value: function () {
      var _getHarvesterPlotsInvalid = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee13(nodeId) {
        var page,
            pageSize,
            _args13 = arguments;
    ...
    value: function () {
      var _getHarvesterPlotsKeysMissing = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee14(nodeId) {
        var page,
            pageSize,
            _args14 = arguments;
    ...
    value: function () {
      var _getHarvesterPlotsDuplicates = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee15(nodeId) {
        var page,
            pageSize,
            _args15 = arguments;
    ...
    value: function () {
      var _getHarvestersSummary = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee16() {
    ...
    value: function () {
      var _getPoolLoginLink = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee17(launcherId) {
...
var FullNode = /*#__PURE__*/function (_Service) {
  _inherits__default["default"](FullNode, _Service);

  var _super = _createSuper$8(FullNode);

  function FullNode(client, options) {
    _classCallCheck__default["default"](this, FullNode);

    return _super.call(this, ServiceName$1.FULL_NODE, client, options);
  }

  _createClass__default["default"](FullNode, [{
    key: "getBlockRecords",
    value: function () {
      var _getBlockRecords = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(start, end) {
        return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
    ...
    value: function () {
      var _getUnfinishedBlockHeaders = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2() {
        return _regeneratorRuntime__default["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    value: function () {
      var _getBlockchainState = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee3() {
        return _regeneratorRuntime__default["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    key: "getConnections",
    value: function () {
      var _getConnections = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee4() {
        return _regeneratorRuntime__default["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
    ...
    key: "openConnection",
    value: function () {
      var _openConnection = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee5(host, port) {
        return _regeneratorRuntime__default["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
    ...
    key: "closeConnection",
    value: function () {
      var _closeConnection = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee6(nodeId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
    ...
    key: "getBlock",
    value: function () {
      var _getBlock = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee7(headerHash) {
        return _regeneratorRuntime__default["default"].wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
    ...
    key: "getBlockRecord",
    value: function () {
      var _getBlockRecord = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee8(headerHash) {
        return _regeneratorRuntime__default["default"].wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
...
var Harvester = /*#__PURE__*/function (_Service) {
  _inherits__default["default"](Harvester, _Service);

  var _super = _createSuper$7(Harvester);

  function Harvester(client, options) {
    _classCallCheck__default["default"](this, Harvester);

    return _super.call(this, ServiceName$1.HARVESTER, client, options);
  } // deprecated


  _createClass__default["default"](Harvester, [{
    key: "getPlots",
    value: function () {
      var _getPlots = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee() {
        return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
    ...
    key: "refreshPlots",
    value: function () {
      var _refreshPlots = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2() {
        return _regeneratorRuntime__default["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    value: function () {
      var _getPlotDirectories = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee3() {
        return _regeneratorRuntime__default["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    key: "deletePlot",
    value: function () {
      var _deletePlot = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee4(filename) {
        return _regeneratorRuntime__default["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
    ...
    value: function () {
      var _addPlotDirectory = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee5(dirname) {
        return _regeneratorRuntime__default["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
    ...
    value: function () {
      var _removePlotDirectory = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee6(dirname) {
        return _regeneratorRuntime__default["default"].wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
...
function mergeQueue(currentQueue, partialQueue, isLogChange) {
  var result = _toConsumableArray__default["default"](currentQueue);
  ...
  partialQueue.forEach(function (item) {
    ...
    if (index === -1) {
      result = [].concat(_toConsumableArray__default["default"](currentQueue), [item]);
      return;
    }
    ...
    result = Object.assign(_toConsumableArray__default["default"](result), _defineProperty__default["default"]({}, index, newItem));
  });
  return addPlotProgress(result);
}

var Plotter = /*#__PURE__*/function (_Service) {
  _inherits__default["default"](Plotter, _Service);
  ...
  function Plotter(client, options) {
    ...
    _classCallCheck__default["default"](this, Plotter);

    return _this = _super.call(this, ServiceName$1.PLOTTER, client, options, /*#__PURE__*/_asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee() {
  ...
  _createClass__default["default"](Plotter, [{
    key: "getQueue",
    value: function () {
      var _getQueue = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2() {
        return _regeneratorRuntime__default["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
...
var Wallet = /*#__PURE__*/function (_Service) {
  _inherits__default["default"](Wallet, _Service);

  var _super = _createSuper$5(Wallet);

  function Wallet(client, options) {
    _classCallCheck__default["default"](this, Wallet);

    return _super.call(this, ServiceName$1.WALLET, client, options);
  }

  _createClass__default["default"](Wallet, [{
    key: "getLoggedInFingerprint",
    value: function () {
      var _getLoggedInFingerprint = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee() {
        return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
    ...
    key: "getWallets",
    value: function () {
      var _getWallets = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2() {
        return _regeneratorRuntime__default["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    key: "getTransaction",
    value: function () {
      var _getTransaction = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee3(transactionId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    key: "getPwStatus",
    value: function () {
      var _getPwStatus = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee4(walletId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
    ...
    key: "pwAbsorbRewards",
    value: function () {
      var _pwAbsorbRewards = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee5(walletId, fee) {
        return _regeneratorRuntime__default["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
    ...
    key: "pwJoinPool",
    value: function () {
      var _pwJoinPool = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee6(walletId, poolUrl, relativeLockHeight, targetPuzzlehash, fee) {
        return _regeneratorRuntime__default["default"].wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
    ...
    key: "pwSelfPool",
    value: function () {
      var _pwSelfPool = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee7(walletId, fee) {
        return _regeneratorRuntime__default["default"].wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
    ...
    key: "createNewWallet",
    value: function () {
      var _createNewWallet = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee8(walletType) {
        var options,
            _args8 = arguments;
        return _regeneratorRuntime__default["default"].wrap(function _callee8$(_context8) {
          while (1) {
    ...
    value: function () {
      var _deleteUnconfirmedTransactions = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee9(walletId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
    ...
    value: function () {
      var _getWalletBalance = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee10(walletId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
    ...
    key: "getFarmedAmount",
    value: function () {
      var _getFarmedAmount = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee11() {
        return _regeneratorRuntime__default["default"].wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
    ...
    key: "sendTransaction",
    value: function () {
      var _sendTransaction = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee12(walletId, amount, fee, address) {
        return _regeneratorRuntime__default["default"].wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
    ...
    value: function () {
      var _generateMnemonic = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee13() {
        return _regeneratorRuntime__default["default"].wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
    ...
    key: "getPublicKeys",
    value: function () {
      var _getPublicKeys = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee14() {
        return _regeneratorRuntime__default["default"].wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
    ...
    key: "addKey",
    value: function () {
      var _addKey = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee15(mnemonic, type, filePath) {
        return _regeneratorRuntime__default["default"].wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
    ...
    key: "deleteKey",
    value: function () {
      var _deleteKey = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee16(fingerprint) {
        return _regeneratorRuntime__default["default"].wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
    ...
    key: "checkDeleteKey",
    value: function () {
      var _checkDeleteKey = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee17(fingerprint) {
        return _regeneratorRuntime__default["default"].wrap(function _callee17$(_context17) {
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
    ...
    key: "deleteAllKeys",
    value: function () {
      var _deleteAllKeys = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee18() {
    ...
    key: "logIn",
    value: function () {
      var _logIn = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee19(fingerprint) {
        var type,
            host,
            filePath,
            _args19 = arguments;
    ...
    key: "getBackupInfo",
    value: function () {
      var _getBackupInfo = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee20(filePath, options) {
    ...
    value: function () {
      var _getBackupInfoByFingerprint = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee21(filePath, fingerprint) {
    ...
    value: function () {
      var _getBackupInfoByWords = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee22(filePath, words) {
    ...
    key: "getPrivateKey",
    value: function () {
      var _getPrivateKey = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee23(fingerprint) {
    ...
    key: "getTransactions",
    value: function () {
      var _getTransactions = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee24(walletId, start, end, sortKey, reverse) {
    ...
    value: function () {
      var _getTransactionsCount = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee25(walletId) {
    ...
    key: "getNextAddress",
    value: function () {
      var _getNextAddress = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee26(walletId, newAddress) {
    ...
    key: "farmBlock",
    value: function () {
      var _farmBlock = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee27(address) {
    ...
    key: "getHeightInfo",
    value: function () {
      var _getHeightInfo = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee28() {
    ...
    key: "getNetworkInfo",
    value: function () {
      var _getNetworkInfo = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee29() {
    ...
    key: "getSyncStatus",
    value: function () {
      var _getSyncStatus = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee30() {
    ...
    key: "getConnections",
    value: function () {
      var _getConnections = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee31() {
    ...
    key: "createBackup",
    value: function () {
      var _createBackup = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee32(filePath) {
    ...
    key: "getAllOffers",
    value: function () {
      var _getAllOffers = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee33(start, end, sortKey, reverse, includeMyOffers, includeTakenOffers) {
    ...
    key: "getOffersCount",
    value: function () {
      var _getOffersCount = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee34() {
    ...
    value: function () {
      var _createOfferForIds = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee35(offer, fee, driverDict, validateOnly, disableJSONFormatting) {
    ...
    key: "cancelOffer",
    value: function () {
      var _cancelOffer = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee36(tradeId, secure, fee) {
    ...
    value: function () {
      var _checkOfferValidity = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee37(offer) {
    ...
    key: "takeOffer",
    value: function () {
      var _takeOffer = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee38(offer, fee) {
    ...
    key: "getOfferSummary",
    value: function () {
      var _getOfferSummary = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee39(offerData) {
    ...
    key: "getOfferData",
    value: function () {
      var _getOfferData = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee40(offerId) {
    ...
    key: "getOfferRecord",
    value: function () {
      var _getOfferRecord = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee41(offerId) {
    ...
    value: function () {
      var _getCurrentDerivationIndex = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee42() {
    ...
    value: function () {
      var _extendDerivationIndex = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee43(index) {
...
var CATWallet = /*#__PURE__*/function (_Wallet) {
  _inherits__default["default"](CATWallet, _Wallet);

  var _super = _createSuper$4(CATWallet);

  function CATWallet() {
    _classCallCheck__default["default"](this, CATWallet);

    return _super.apply(this, arguments);
  }

  _createClass__default["default"](CATWallet, [{
    key: "createNewWallet",
    value: function () {
      var _createNewWallet = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(amount, fee) {
        var host,
            _args = arguments;
        return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", _get__default["default"](_getPrototypeOf__default["default"](CATWallet.prototype), "createNewWallet", this).call(this, 'cat_wallet', {
                  mode: 'new',
                  amount: amount,
                  fee: fee,
                  host: host
    ...
    value: function () {
      var _createWalletForExisting = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2(assetId, fee) {
        var host,
            _args2 = arguments;
        return _regeneratorRuntime__default["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", _get__default["default"](_getPrototypeOf__default["default"](CATWallet.prototype), "createNewWallet", this).call(this, 'cat_wallet', {
                  mode: 'existing',
                  assetId: assetId,
                  fee: fee,
                  host: host
    ...
    key: "getAssetId",
    value: function () {
      var _getAssetId = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee3(walletId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    key: "getName",
    value: function () {
      var _getName = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee4(walletId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
    ...
    key: "setName",
    value: function () {
      var _setName = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee5(walletId, name) {
        return _regeneratorRuntime__default["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
    ...
    key: "spend",
    value: function () {
      var _spend = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee6(walletId, innerAddress, amount, fee, memos) {
        return _regeneratorRuntime__default["default"].wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
    ...
    key: "getCatList",
    value: function () {
      var _getCatList = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee7() {
        return _regeneratorRuntime__default["default"].wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
    ...
    key: "getStrayCats",
    value: function () {
      var _getStrayCats = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee8() {
        return _regeneratorRuntime__default["default"].wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
...
var DIDWallet = /*#__PURE__*/function (_Wallet) {
  _inherits__default["default"](DIDWallet, _Wallet);

  var _super = _createSuper$3(DIDWallet);

  function DIDWallet() {
    _classCallCheck__default["default"](this, DIDWallet);

    return _super.apply(this, arguments);
  }

  _createClass__default["default"](DIDWallet, [{
    key: "createNewWallet",
    value: function () {
      var _createNewWallet = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(amount, fee, backupDids, numOfBackupIdsNeeded) {
        var host,
            _args = arguments;
        return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", _get__default["default"](_getPrototypeOf__default["default"](DIDWallet.prototype), "createNewWallet", this).call(this, 'did_wallet', {
                  did_type: 'new',
                  amount: amount,
                  fee: fee,
    ...
    value: function () {
      var _createNewRecoveryWallet = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2(filename) {
        var host,
            _args2 = arguments;
        return _regeneratorRuntime__default["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", _get__default["default"](_getPrototypeOf__default["default"](DIDWallet.prototype), "createNewWallet", this).call(this, 'did_wallet', {
                  did_type: 'recovery',
                  filename: filename,
                  host: host
                }));
    ...
    value: function () {
      var _updateRecoveryIds = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee3(walletId, newList, numVerificationsRequired) {
        return _regeneratorRuntime__default["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    key: "getPubKey",
    value: function () {
      var _getPubKey = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee4(walletId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
    ...
    key: "spend",
    value: function () {
      var _spend = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee5(walletId, puzzlehash) {
        return _regeneratorRuntime__default["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
    ...
    key: "getDid",
    value: function () {
      var _getDid = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee6(walletId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
    ...
    key: "getDidName",
    value: function () {
      var _getDidName = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee7(walletId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
    ...
    key: "setDIDName",
    value: function () {
      var _setDIDName = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee8(walletId, name) {
        return _regeneratorRuntime__default["default"].wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
    ...
    key: "getRecoveryList",
    value: function () {
      var _getRecoveryList = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee9(walletId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
    ...
    key: "recoverySpend",
    value: function () {
      var _recoverySpend = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee10(walletId, attestFilenames) {
        return _regeneratorRuntime__default["default"].wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
    ...
    key: "createAttest",
    value: function () {
      var _createAttest = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee11(walletId, filename, coinName, pubkey, puzhash) {
        return _regeneratorRuntime__default["default"].wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
    ...
    value: function () {
      var _createBackupFile = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee12(walletId, filename) {
        return _regeneratorRuntime__default["default"].wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
    ...
    value: function () {
      var _getInformationNeededForRecovery = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee13(walletId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
    ...
    value: function () {
      var _getCurrentCoinInfo = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee14(walletId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
...
var NFTWallet = /*#__PURE__*/function (_Wallet) {
  _inherits__default["default"](NFTWallet, _Wallet);

  var _super = _createSuper$2(NFTWallet);

  function NFTWallet() {
    _classCallCheck__default["default"](this, NFTWallet);

    return _super.apply(this, arguments);
  }

  _createClass__default["default"](NFTWallet, [{
    key: "getNfts",
    value: function () {
      var _getNfts = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(walletId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
    ...
    key: "getNftInfo",
    value: function () {
      var _getNftInfo = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2(coinId) {
        return _regeneratorRuntime__default["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    value: function () {
      var _getNftWalletsWithDids = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee3() {
        return _regeneratorRuntime__default["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    key: "transferNft",
    value: function () {
      var _transferNft = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee4(walletId, nftCoinId, targetAddress, fee) {
        return _regeneratorRuntime__default["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
    ...
    key: "setNftDid",
    value: function () {
      var _setNftDid = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee5(walletId, nftCoinId, did, fee) {
        return _regeneratorRuntime__default["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
    ...
    key: "setNftStatus",
    value: function () {
      var _setNftStatus = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee6(walletId, nftCoinId, inTransaction) {
        return _regeneratorRuntime__default["default"].wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
    ...
    key: "receiveNft",
    value: function () {
      var _receiveNft = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee7(walletId, spendBundle, fee) {
        return _regeneratorRuntime__default["default"].wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
...
var PoolWallet = /*#__PURE__*/function (_Wallet) {
  _inherits__default["default"](PoolWallet, _Wallet);

  var _super = _createSuper$1(PoolWallet);

  function PoolWallet() {
    _classCallCheck__default["default"](this, PoolWallet);

    return _super.apply(this, arguments);
  }

  _createClass__default["default"](PoolWallet, [{
    key: "createNewWallet",
    value: function () {
      var _createNewWallet = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(initialTargetState, fee) {
        var host,
            _args = arguments;
        return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                host = _args.length > 2 && _args[2] !== undefined ? _args[2] : this.client.backupHost;
                return _context.abrupt("return", _get__default["default"](_getPrototypeOf__default["default"](PoolWallet.prototype), "createNewWallet", this).call(this, 'pool_wallet', {
                  mode: 'new',
                  fee: fee,
                  host: host,
...
var RLWallet = /*#__PURE__*/function (_Wallet) {
  _inherits__default["default"](RLWallet, _Wallet);

  var _super = _createSuper(RLWallet);

  function RLWallet() {
    _classCallCheck__default["default"](this, RLWallet);

    return _super.apply(this, arguments);
  }

  _createClass__default["default"](RLWallet, [{
    key: "createAdminWallet",
    value: function () {
      var _createAdminWallet = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(interval, limit, pubkey, amount) {
        var host,
            _args = arguments;
        return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
          while (1) {
    ...
    value: function () {
      var _createUserWallet = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2() {
        var host,
            _args2 = arguments;
        return _regeneratorRuntime__default["default"].wrap(function _callee2$(_context2) {
          while (1) {
    ...
    key: "setUserInfo",
    value: function () {
      var _setUserInfo = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee3(walletId, interval, limit, origin, adminPubkey) {
        return _regeneratorRuntime__default["default"].wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    key: "clawbackCoin",
    value: function () {
      var _clawbackCoin = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee4() {
        return _regeneratorRuntime__default["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
...
var ServiceHumanName = (_ServiceName$WALLET$S = {}, _defineProperty__default["default"](_ServiceName$WALLET$S, ServiceName$1.WALLET, 'Wallet'), _defineProperty__default["default"](_ServiceName$WALLET$S, ServiceName$1.FULL_NODE, 'Full Node'), _defineProperty__default["default"](_ServiceName$WALLET$S, ServiceName$1.FARMER, 'Farmer'), _defineProperty__default["default"](_ServiceName$WALLET$S, ServiceName$1.HARVESTER, 'Harvester'), _defineProperty__default["default"](_ServiceName$WALLET$S, ServiceName$1.SIMULATOR, 'Full Node Simulator'), _defineProperty__default["default"](_ServiceName$WALLET$S, ServiceName$1.DAEMON, 'Daemon'), _defineProperty__default["default"](_ServiceName$WALLET$S, ServiceName$1.PLOTTER, 'Plotter'), _defineProperty__default["default"](_ServiceName$WALLET$S, ServiceName$1.TIMELORD, 'Timelord'), _defineProperty__default["default"](_ServiceName$WALLET$S, ServiceName$1.INTRODUCER, 'Introducer'), _defineProperty__default["default"](_ServiceName$WALLET$S, ServiceName$1.EVENTS, 'Events'), _ServiceName$WALLET$S);
...
function toBech32m(value, prefix) {
  ...
  var words = bech32.bech32m.toWords(Buffer.from(pureHash, 'hex'));
  return bech32.bech32m.encode(prefix, words);
}
function fromBech32m(value) {
  var data = bech32.bech32m.decode(value);
  return Buffer.from(bech32.bech32m.fromWords(data.words)).toString('hex');
}
function decodeBech32m(value) {
  var _bech32m$decode = bech32.bech32m.decode(value),
      words = _bech32m$decode.words,
      prefix = _bech32m$decode.prefix;

  var data = Buffer.from(bech32.bech32m.fromWords(words)).toString('hex');
  return {
    prefix: prefix,
    data: data
  };
...
exports.CAT = CATWallet;
exports.ConnectionState = ConnectionState$1;
exports.DID = DIDWallet;
exports.Daemon = Daemon;
exports.Events = Events;
exports.Farmer = Farmer;
exports.FullNode = FullNode;
exports.Harvester = Harvester;
exports.NFT = NFTWallet;
exports.PassphrasePromptReason = PassphrasePromptReason$1;
exports.Plotter = Plotter;
exports.PlotterName = PlotterName$1;
exports.Pool = PoolWallet;
exports.RL = RLWallet;
exports.Service = Service;
exports.ServiceConnectionName = ServiceConnectionName;
exports.ServiceHumanName = ServiceHumanName;
exports.ServiceName = ServiceName$1;
exports.SyncingStatus = SyncingStatus$1;
exports.TransactionType = TransactionType$1;
exports.Wallet = Wallet;
exports.WalletType = WalletType$1;
exports.decodeBech32m = decodeBech32m;
exports["default"] = Client;
exports.defaultPlotter = defaultPlotter;
exports.defaultsForPlotter = defaultsForPlotter;
exports.english = english;
exports.fromBech32m = fromBech32m;
exports.optionsForPlotter = optionsForPlotter;
exports.toBech32m = toBech32m;
