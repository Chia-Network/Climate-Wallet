import React, { useState, useCallback, useMemo, useEffect, createContext, useContext, cloneElement, Component, Suspense, memo, forwardRef, useRef, Fragment as Fragment$1 } from 'react';
import { Collapse, Stack, Tooltip as Tooltip$1, IconButton, Box, Typography, DialogActions as DialogActions$1, Button as Button$1, Dialog, DialogTitle, DialogContent, TextField as TextField$1, FormControl, FormHelperText, InputAdornment, Autocomplete as Autocomplete$1, DialogContentText, Card as Card$1, CardContent, Grid, TableCell, Table as Table$1, TableBody, TableRow, CardActionArea, CircularProgress, Avatar, CardHeader, Divider, Checkbox as Checkbox$1, Paper, useMediaQuery, Menu, MenuItem, AppBar, Toolbar, Link as Link$2, LinearProgress, InputBase as InputBase$1, ButtonGroup, Drawer, Container, RadioGroup as RadioGroup$1, Select as Select$1, ListItemIcon, ListItem, Backdrop, TableHead, TableContainer, TablePagination, CssBaseline, ListItemText, ListItemSecondaryAction, Alert, List } from '@mui/material';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import styled$3, { createGlobalStyle, ThemeProvider as ThemeProvider$1 } from 'styled-components';
import { toBech32m, decodeBech32m } from '@chia/api';
import { useGetNetworkInfoQuery, useLogout, useGetLoggedInFingerprintQuery, useGetKeyringStatusQuery, useGetPrivateKeyQuery, useDeleteKeyMutation, useCheckDeleteKeyMutation, useDeleteAllKeysMutation, useLogInAndSkipImportMutation, useGetPublicKeysQuery } from '@chia/api-react';
import _defineProperty from '@babel/runtime/helpers/defineProperty';
import _objectWithoutProperties from '@babel/runtime/helpers/objectWithoutProperties';
import _slicedToArray from '@babel/runtime/helpers/slicedToArray';
import { Trans, I18nProvider, useLingui } from '@lingui/react';
import { useCopyToClipboard, useToggle, useUpdate } from 'react-use';
import { Assignment, KeyboardArrowUp, KeyboardArrowDown, ArrowBackIosNew, Check, Help, Brightness7, Brightness4, ExpandMore, ArrowBackIos, FiberManualRecord, Translate, AccountBalanceWallet, WbSunny, NightsStay, Settings as Settings$1, Close, ExitToApp, MoreVert, Visibility, Delete } from '@mui/icons-material';
import { useTimeout } from 'react-use-timeout';
import _extends from '@babel/runtime/helpers/esm/extends';
import _objectWithoutPropertiesLoose from '@babel/runtime/helpers/esm/objectWithoutPropertiesLoose';
import styled$2 from '@mui/styled-engine-sc';
import { deepmerge, unstable_capitalize, getDisplayName } from '@mui/utils';
import { useNavigate, Link as Link$1, Outlet, Navigate, Route, useMatch, useLocation } from 'react-router-dom';
import NumberFormat from 'react-number-format';
import { useFormContext, Controller, useWatch, useController, FormProvider } from 'react-hook-form';
import { get, sumBy, isString } from 'lodash';
import _classCallCheck from '@babel/runtime/helpers/classCallCheck';
import _createClass from '@babel/runtime/helpers/createClass';
import BigNumber from 'bignumber.js';
import moment from 'moment';
import { useLocalStorage as useLocalStorage$1, writeStorage } from '@rehooks/local-storage';
...
import { styled as styled$4, alpha, createTheme as createTheme$1, ThemeProvider as ThemeProvider$2 } from '@mui/material/styles';
...
import { styled as styled$5, makeStyles, createStyles } from '@mui/styles';
import qs from 'qs';
...
import { useNavigate as useNavigate$1, Outlet as Outlet$1 } from 'react-router';
import { useSelector } from 'react-redux';
import { i18n } from '@lingui/core';
import { Chia as Chia$1, Farming } from '@chia/icons';
import _extends$1 from '@babel/runtime/helpers/extends';
import ScrollToBottom from 'react-scroll-to-bottom';
import _taggedTemplateLiteral from '@babel/runtime/helpers/taggedTemplateLiteral';
import { Flex as Flex$1 } from '@chia/core';
...
function useCurrencyCode() {
  var _useGetNetworkInfoQue = useGetNetworkInfoQuery(),
...
function Flex(props) {
  ...
  return /*#__PURE__*/jsx(Stack, _objectSpread$M({
  ...
  const fn = props => {
    ...
    const styleFromPropValue = propValueFinal => {
      ...
      if (propValueFinal === value && typeof propValueFinal === 'string') {
        // Haven't found value
        value = getValue$1(themeMapping, transform, `${prop}${propValueFinal === 'default' ? '' : unstable_capitalize(propValueFinal)}`, propValueFinal);
      }
...
function propsToClassKey(props) {
  ...
  Object.keys(other).sort().forEach(key => {
    if (key === 'color') {
      classKey += isEmpty$1(classKey) ? props[key] : unstable_capitalize(props[key]);
    } else {
      classKey += `${isEmpty$1(classKey) ? key : unstable_capitalize(key)}${unstable_capitalize(props[key].toString())}`;
    }
  });
  return classKey;
}
...
var StyledAssignmentIcon = styled$1(Assignment)(function (_ref) {
...
function CopyToClipboard(props) {
  ...
  var tooltipTitle = copied ? /*#__PURE__*/jsx(Trans, {
    id: "Copied"
  }) : /*#__PURE__*/jsx(Trans, {
  ...
  return /*#__PURE__*/jsx(Tooltip$1, {
    ...
    children: /*#__PURE__*/jsx(IconButton, {
      ...
      children: /*#__PURE__*/jsx(StyledAssignmentIcon, _objectSpread$L({
        fontSize: fontSize,
...
function Tooltip(props) {
  ...
  var titleContent = copyToClipboard ? /*#__PURE__*/jsxs(Flex, {
    alignItems: "center",
    gap: 1,
  ...
  return /*#__PURE__*/jsx(Tooltip$1, _objectSpread$K({
    title: titleContent,
...
var StyledValue$1 = styled$3(Box).withConfig({
...
function Address(props) {
  ...
  var address = currencyCode && value ? toBech32m(value, currencyCode.toLowerCase()) : '';
  ...
  if (!children) {
    if (copyToClipboard) {
      return /*#__PURE__*/jsxs(Flex, {
        alignItems: "center",
        gap: 1,
        children: [/*#__PURE__*/jsx(StyledValue$1, {
          children: address
        }), /*#__PURE__*/jsx(CopyToClipboard, {
          value: address,
          fontSize: "small"
  ...
  if (copyToClipboard) {
    return /*#__PURE__*/jsxs(Flex, {
      alignItems: "center",
      gap: 1,
      children: [children(address), " asdf", /*#__PURE__*/jsx(CopyToClipboard, {
        value: address,
        fontSize: "small"
      })]
    });
...
var StyledToggleAdvancedOptions = styled$3(function (_ref) {
  _ref.expanded;
      var rest = _objectWithoutProperties(_ref, _excluded$B);

  return /*#__PURE__*/jsx(Typography, _objectSpread$J({}, rest));
}).withConfig({
...
function AdvancedOptions(props) {
  ...
  var _useToggle = useToggle(defaultExpanded),
  ...
  return /*#__PURE__*/jsxs(Flex, {
    ...
    gap: 1,
    children: [!hideTitle && /*#__PURE__*/jsx(StyledToggleAdvancedOptions, {
      variant: "caption",
      expanded: isExpanded,
      onClick: handleToggle,
      children: isExpanded ? /*#__PURE__*/jsxs(Flex, {
        alignItems: "center",
        children: [/*#__PURE__*/jsx(KeyboardArrowUp, {}), lessTitle]
      }) : /*#__PURE__*/jsxs(Flex, {
        alignItems: "center",
        children: [/*#__PURE__*/jsx(KeyboardArrowDown, {}), moreTitle]
      })
...
AdvancedOptions.defaultProps = {
  ...
  children: undefined,
  hideExpanded: false,
  moreTitle: /*#__PURE__*/jsx(Trans, {
    id: "Show Advanced Options"
  }),
  lessTitle: /*#__PURE__*/jsx(Trans, {
    id: "Hide Advanced Options"
  })
};

var DialogActions = styled$3(DialogActions$1).withConfig({
...
var StyledBaseButton = styled$3(function (_ref) {
  _ref.nowrap;
      _ref.selected;
      var rest = _objectWithoutProperties(_ref, _excluded$A);

  return /*#__PURE__*/jsx(Button$1, _objectSpread$I({}, rest));
}).withConfig({
...
var DangerButton = styled$3(StyledBaseButton).withConfig({
...
function Button(props) {
  ...
  switch (color) {
    case 'danger':
      return /*#__PURE__*/jsx(DangerButton, _objectSpread$I({
        onClick: handleClick,
        disableElevation: disableElevation
      }, rest));

    case 'primary':
      return /*#__PURE__*/jsx(StyledBaseButton, _objectSpread$I({
        onClick: handleClick,
        disableElevation: disableElevation,
        color: "primary"
      }, rest));
...
function AlertDialog(props) {
  ...
  return /*#__PURE__*/jsxs(Dialog, {
    ...
    open: open,
    children: [title && /*#__PURE__*/jsx(DialogTitle, {
...
function TextField(props) {
  ...
  var errorMessage = get(errors, name);
  return (
    /*#__PURE__*/
    // @ts-ignore
    jsx(Controller, {
      ...
      render: function render(_ref) {
        ...
        return /*#__PURE__*/jsx(TextField$1, _objectSpread$H({
          value: value,
...
var _UnitValue;
var UnitValue = (_UnitValue = {}, _defineProperty(_UnitValue, Unit$1.CHIA, 1), _defineProperty(_UnitValue, Unit$1.MOJO, 1 / 1e12), _defineProperty(_UnitValue, Unit$1.CAT, 1 / 1e9), _UnitValue);
...
function activateLocale(i18n, locale) {
  ...
  moment.locale([locale, 'en']); // @ts-ignore
...
function useLocalStorage(storageKey, defaultValue) {
  var _useLocalStorageBase = useLocalStorage$1(storageKey, defaultValue),
      _useLocalStorageBase2 = _slicedToArray(_useLocalStorageBase, 1),
...
function LocaleProvider(props) {
  ...
  var handleSetLocale = useCallback(function (locale) {
...
function FormatLargeNumber(props) {
  ...
  var numberFormat = useMemo(function () {
    return new Intl.NumberFormat(locale);
  }, [locale]);
  var formatedValue = useMemo(function () {
...
function NumberFormatCustom$1(props) {
  ...
  return /*#__PURE__*/jsx(NumberFormat, _objectSpread$G(_objectSpread$G({}, other), {}, {
...
function Amount(props) {
  ...
  return /*#__PURE__*/jsxs(FormControl, {
    variant: variant,
    fullWidth: fullWidth,
    children: [/*#__PURE__*/jsx(TextField, _objectSpread$G({
      name: name,
      variant: variant,
      autoComplete: "off",
      InputProps: {
      ...
      children: /*#__PURE__*/jsxs(Flex, {
        alignItems: "center",
        gap: 2,
        children: [showAmountInMojos && /*#__PURE__*/jsx(Flex, {
          flexGrow: 1,
          gap: 1,
          children: !mojo.isZero() && /*#__PURE__*/jsxs(Fragment, {
...
var OuterWrapper = styled$3(function (_ref) {
  _ref.ration;
      var rest = _objectWithoutProperties(_ref, _excluded$x);

  return /*#__PURE__*/jsx(Box, _objectSpread$F({}, rest));
}).withConfig({
...
var InnerWrapper = styled$3(Box).withConfig({
...
function AspectRatio(props) {
  var children = props.children,
      ratio = props.ratio;
  return /*#__PURE__*/jsx(OuterWrapper, {
    ratio: ratio,
    children: /*#__PURE__*/jsx(InnerWrapper, {
      children: children
    })
  });
}
...
function Autocomplete(props) {
  ...
  return /*#__PURE__*/jsx(Autocomplete$1, {
    ...
    renderInput: function renderInput(params) {
      return /*#__PURE__*/jsx(TextField$1, _objectSpread$E(_objectSpread$E({
        autoComplete: "off",
        error: errorMessage,
...
var ModalDialogsContext = /*#__PURE__*/createContext();
...
function useOpenDialog() {
  ...
  var context = useContext(ModalDialogsContext);
  ...
  function _handleOpen() {
    _handleOpen = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(dialog) {
      var result;
...
function ButtonLoading(props) {
  ...
  return /*#__PURE__*/jsx(LoadingButton, _objectSpread$D({
    onClick: handleClick,
    loading: loading,
    color: color
  }, rest));
...
function useShowError() {
  ...
  function _showError() {
    _showError = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(error) {
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", openDialog( /*#__PURE__*/jsx(AlertDialog, {
...
function ConfirmDialog(props) {
  ...
  return /*#__PURE__*/jsxs(Dialog, _objectSpread$C(_objectSpread$C({
...
ConfirmDialog.defaultProps = {
  ...
  title: undefined,
  children: undefined,
  cancelTitle: /*#__PURE__*/jsx(Trans, {
    id: "Cancel"
  }),
...
function Back(props) {
  ...
  function _handleGoBack() {
    _handleGoBack = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
      var canGoBack;
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
  ...
  return /*#__PURE__*/jsxs(Flex, {
    ...
    children: [/*#__PURE__*/jsx(IconButton, {
      ...
      sx: iconStyle,
      children: /*#__PURE__*/jsx(ArrowBackIosNew, {})
...
function ButtonSelected(props) {
  ...
  return /*#__PURE__*/jsx(Button, _objectSpread$B(_objectSpread$B({
    color: color
  }, rest), {}, {
    children: selected ? /*#__PURE__*/jsxs(Fragment, {
      children: [/*#__PURE__*/jsx(Check, {}), " ", children]
    }) : children
  }));
}

var StyledHelpIcon = styled$3(Help).withConfig({
...
var StyledCardTitle = styled$3(Box).withConfig({
...
var StyledCardMaterial = styled$3(function (_ref2) {
  _ref2.cursor;
      _ref2.opacity;
      _ref2.clickable;
      _ref2.fullHeight;
      _ref2.highlight;
      _ref2.transparent;
      var rest = _objectWithoutProperties(_ref2, _excluded$s);

  return /*#__PURE__*/jsx(Card$1, _objectSpread$A({}, rest));
}).withConfig({
...
var StyledCardContent$2 = styled$3(function (_ref10) {
  _ref10.fullHeight;
      _ref10.transparent;
      var rest = _objectWithoutProperties(_ref10, _excluded2$5);

  return /*#__PURE__*/jsx(CardContent, _objectSpread$A({}, rest));
}).withConfig({
...
var StyledRoot$4 = styled$3(function (_ref14) {
  _ref14.fullHeight;
      var rest = _objectWithoutProperties(_ref14, _excluded3$1);

  return /*#__PURE__*/jsx(Flex, _objectSpread$A({}, rest));
}).withConfig({
...
var StyledHighlight = styled$3(Box).withConfig({
...
function Card(props) {
  ...
  var headerTitle = tooltip ? /*#__PURE__*/jsxs(Flex, {
    alignItems: "center",
    gap: 1,
    children: [/*#__PURE__*/jsx(Box, {
      children: title
  ...
  return /*#__PURE__*/jsxs(StyledRoot$4, {
    fullHeight: fullHeight,
    children: [highlight === false && /*#__PURE__*/jsx(StyledHighlight, {
      empty: true,
      children: "\xA0"
    }), highlight && /*#__PURE__*/jsx(StyledHighlight, {
      children: highlight
    }), /*#__PURE__*/jsxs(StyledCardMaterial, {
      onClick: handleClick,
      clickable: !!onSelect,
      disabled: disabled,
      fullHeight: fullHeight,
      ...
      children: [title && /*#__PURE__*/jsx(StyledCardTitle, {
        transparent: transparent,
        children: /*#__PURE__*/jsxs(Flex, {
          gap: 2,
          alignItems: "center",
      ...
      }), /*#__PURE__*/jsx(StyledCardContent$2, {
        fullHeight: fullHeight,
        transparent: transparent,
        children: /*#__PURE__*/jsxs(Flex, {
          flexDirection: "column",
...
var StyledContent$1 = styled$3(CardContent).withConfig({
...
function CardHero(props) {
  ...
  return /*#__PURE__*/jsx(Card$1, {
    children: /*#__PURE__*/jsx(StyledContent$1, {
      children: /*#__PURE__*/jsx(Flex, {
        flexDirection: "column",
        gap: 3,
        children: children
...
var StyledTableCell$1 = styled$3(function (_ref) {
  _ref.hideDivider;
      var rest = _objectWithoutProperties(_ref, _excluded$r);

  return /*#__PURE__*/jsx(TableCell, _objectSpread$z({}, rest));
}).withConfig({
    ...
    children: /*#__PURE__*/jsx(TableBody, {
      children: rows.map(function (row) {
        return /*#__PURE__*/jsxs(TableRow, {
          children: [/*#__PURE__*/jsx(StyledTableCell$1, {
          ...
          }), /*#__PURE__*/jsx(StyledTableCell$1, {
            hideDivider: hideDivider,
            width: "100%",
            children: /*#__PURE__*/jsx(Box, {
              ml: 2,
...
var StyledCard$1 = styled$1(Card$1, {
...
var StyledCardContent$1 = styled$1(CardContent)(function (_ref2) {
...
function CardListItem(props) {
  ...
  var content = /*#__PURE__*/jsx(StyledCardContent$1, {
    children: children
  });

  return /*#__PURE__*/jsx(StyledCard$1, _objectSpread$y(_objectSpread$y({
    variant: "outlined",
    selected: selected
  }, rest), {}, {
    children: onSelect ? /*#__PURE__*/jsx(CardActionArea, {
      onClick: onSelect,
      children: content
    }) : content
  }));
        ...
        children: /*#__PURE__*/jsxs(Flex, {
          ...
          children: [/*#__PURE__*/jsxs(Flex, {
            ...
            children: [/*#__PURE__*/jsx(Typography, {
              color: "textSecondary",
              children: title
            }), tooltip && /*#__PURE__*/jsx(TooltipIcon, {
              children: tooltip
            })]
          }), actions]
        })
...
var StyledCardContent = styled$3(CardContent).withConfig({
  displayName: "CardStep__StyledCardContent",
  componentId: "sc-1c8ppdm-0"
})(["padding-left:72px;"]);
var StyledStep = styled$3(Avatar).withConfig({
...
function CardStep(props) {
  ...
  return /*#__PURE__*/jsxs(Card$1, {
    children: [/*#__PURE__*/jsx(CardHeader, {
      avatar: /*#__PURE__*/jsx(StyledStep, {
        "aria-label": "step",
        children: step
      }),
      ...
      action: action
    }), /*#__PURE__*/jsx(Divider, {}), /*#__PURE__*/jsx(StyledCardContent, {
...
var ParseBoolean$1 = function ParseBoolean(props) {
  ...
  return /*#__PURE__*/jsx(Checkbox$1, _objectSpread$x({
    onChange: handleChange
  }, rest));
};
  ...
  return (
    ...
    jsx(Controller, {
      ...
      render: function render(_ref) {
        ...
        return /*#__PURE__*/jsx(ParseBoolean$1, _objectSpread$x(_objectSpread$x({}, field), rest));
      }
    })
  );
}
...
var StyledPaper$1 = styled$3(Paper).withConfig({
...
function Dropzone(props) {
  ...
  var _useDropzone = useDropzone(config),
  ...
  return /*#__PURE__*/jsxs("div", _objectSpread$w(_objectSpread$w({}, getRootProps()), {}, {
    children: [/*#__PURE__*/jsx("input", _objectSpread$w({}, getInputProps())), /*#__PURE__*/jsx(StyledPaper$1, {
      children: /*#__PURE__*/jsx(AspectRatio, {
        ...
        children: /*#__PURE__*/jsx(Flex, {
          ...
          flexDirection: "column",
          height: "100%",
          children: processing ? /*#__PURE__*/jsx(CircularProgress, {
            color: "secondary"
          }) : childrenContent
        })
      })
...
function Fee(props) {
  return /*#__PURE__*/jsx(Amount, _objectSpread$v(_objectSpread$v({}, props), {}, {
    children: function children(_ref) {
      ...
      if (isHigh) {
        return /*#__PURE__*/jsx(StyledWarning, {
          children: /*#__PURE__*/jsx(Trans, {
            id: "Value seems high"
          })
        });
      ...
      if (isLow) {
        return /*#__PURE__*/jsx(StyledError, {
          children: /*#__PURE__*/jsx(Trans, {
            id: "Incorrect value"
          })
        });
...
function Heading(props) {
  ...
  return /*#__PURE__*/jsx(Typography, _objectSpread$u({
...
function DarkModeToggle() {
  ...
  return /*#__PURE__*/jsx(IconButton, {
    color: "inherit",
    onClick: handleClick,
    children: isDarkMode ? /*#__PURE__*/jsx(Brightness7, {}) : /*#__PURE__*/jsx(Brightness4, {})
  });
}
...
function Dropdown(props) {
  ...
  var selected = props.selected,
      ...
      children = props.children;
      props.open;
      var rest = _objectWithoutProperties(props, _excluded$n);

  var _useToggle = useToggle(defaultOpen),
      _useToggle2 = _slicedToArray(_useToggle, 2),
      open = _useToggle2[0],
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(Button$1, {
      ...
      "aria-haspopup": "true",
      onClick: handleClick,
      endIcon: /*#__PURE__*/jsx(ExpandMore, {}),
      startIcon: startIcon,
      children: children ? children(selectedOption) : value
    }), /*#__PURE__*/jsx(Menu, _objectSpread$t(_objectSpread$t({
      id: "dropdown",
      anchorEl: anchorEl,
      onClose: handleClose,
...
Dropdown.defaultProps = {
  defaultOpen: false,
  placeholder: /*#__PURE__*/jsx(Trans, {
    id: "Select..."
  }),
  startIcon: undefined,
  children: undefined
...
var StyledMenu$1 = styled$4(function (props) {
  return /*#__PURE__*/jsx(Menu$1, _objectSpread$s({
    elevation: 0,
    anchorOrigin: {
      vertical: 'bottom',
      horizontal: 'right'
...
function DropdownActions$1(props) {
  ...
  return /*#__PURE__*/jsxs("div", {
    children: [toggle ? /*#__PURE__*/cloneElement(toggle, {
      onClick: handleClick
    }) : /*#__PURE__*/jsx(Button$2, _objectSpread$s(_objectSpread$s({
      variant: "contained",
      onClick: handleClick,
...
var StyledMenu = styled$4(function (props) {
  return /*#__PURE__*/jsx(Menu$1, _objectSpread$r({
    elevation: 0,
    anchorOrigin: {
      vertical: 'bottom',
      horizontal: 'right'
...
function DropdownActions(props) {
  ...
  var _children = children({
    ...
    open: open
      ...
      _children2 = _slicedToArray(_children, 2),
      item = _children2[0],
      menuItems = _children2[1];

  return /*#__PURE__*/jsxs(Box, {
    children: [item, /*#__PURE__*/jsx(StyledMenu, {
      anchorEl: anchorEl,
      open: open,
      onClose: handleClose,
      children: menuItems
...
function DropdownIconButton(props) {
  ...
  return /*#__PURE__*/jsx(DropdownActions, {
    children: function children(_ref) {
      var onClose = _ref.onClose,
          onToggle = _ref.onToggle,
          open = _ref.open;
      return [/*#__PURE__*/jsx(IconButton, _objectSpread$q(_objectSpread$q({
        onClick: onToggle
      }, rest), {}, {
        children: icon
      }), "button"), _children({
...
var StyledWrapper = styled$3(Box).withConfig({
...
var StyledBody$3 = styled$3(Box).withConfig({
  ...
  return /*#__PURE__*/jsxs(StyledWrapper, {
    children: [/*#__PURE__*/jsx(AppBar, {
      ...
      children: /*#__PURE__*/jsxs(Toolbar, {
        children: [header, back && /*#__PURE__*/jsx(Link$1, {
          to: "-1",
          children: /*#__PURE__*/jsx(ArrowBackIos, {
            fontSize: "large",
            color: "secondary"
          })
        }), /*#__PURE__*/jsx(Flex, {
    ...
    }), /*#__PURE__*/jsx(StyledBody$3, {
      children: /*#__PURE__*/jsx(Flex, {
        flexDirection: "column",
        gap: 2,
        alignItems: "center",
        alignSelf: "stretch",
        children: outlet ? /*#__PURE__*/jsx(Outlet, {}) : children
      })
    })]
  });
}
...
var StyledBaseLink = styled$3(function (_ref) {
  _ref.fullWidth;
      _ref.noWrap;
      var rest = _objectWithoutProperties(_ref, _excluded$k);

  return /*#__PURE__*/jsx(Link$2, _objectSpread$p({}, rest));
}).withConfig({
...
function Link(props) {
  ...
  return /*#__PURE__*/jsx(StyledBaseLink, _objectSpread$p(_objectSpread$p({
    component: to ? Link$1 : Link$2
  }, newProps), {}, {
    onClick: handleClick
  }));
}
...
var StyledPre = styled$5(Typography)(function () {
  return {
    whiteSpace: 'pre-wrap'
  };
});
...
var ErrorBoundary = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ErrorBoundary, [{
    ...
    value: function () {
      var _componentDidUpdate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(_prevProps, prevState) {
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return StackTrace.fromError(this.state.error);
    ...
    value: function render() {
      if (this.state.hasError) {
        ...
        var issueLink = "https://github.com/Chia-Network/chia-blockchain-gui/issues/new?".concat(qs.stringify({
          labels: 'bug',
        ...
        return /*#__PURE__*/jsx(LayoutHero, {
          children: /*#__PURE__*/jsxs(Flex, {
            flexDirection: "column",
            gap: 4,
            children: [/*#__PURE__*/jsx(Typography, {
...
var Fonts = createGlobalStyle(["body{font-family:\"Roboto\";}"]);
...
function Form(props) {
  ...
  function _processSubmit() {
    _processSubmit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
      var _args = arguments;
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
  ...
  return /*#__PURE__*/jsx(FormProvider, _objectSpread$o(_objectSpread$o({}, methods), {}, {
    children: /*#__PURE__*/jsx("form", _objectSpread$o({
...
function FormBackButton(props) {
  ...
  function _handleBack() {
    _handleBack = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
      var canGoBack;
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
  ...
  return /*#__PURE__*/jsx(Button, _objectSpread$n(_objectSpread$n({
    onClick: handleBack
  }, rest), {}, {
    children: children
  }));
...
var Convert = [[new BigNumber(0), 'B'], [new BigNumber(1024).exponentiatedBy(1), 'KiB'], [new BigNumber(1024).exponentiatedBy(2), 'MiB'], [new BigNumber(1024).exponentiatedBy(3), 'GiB'], [new BigNumber(1024).exponentiatedBy(4), 'TiB'], [new BigNumber(1024).exponentiatedBy(5), 'PiB'], [new BigNumber(1024).exponentiatedBy(6), 'EiB'], [new BigNumber(1024).exponentiatedBy(7), 'ZiB'], [new BigNumber(1024).exponentiatedBy(8), 'YiB']];
...
function FormatBytes(props) {
  ...
  if (unit) {
    ...
    var _Convert$unitIndex = _slicedToArray(Convert[unitIndex], 2),
    ...
    var _CovertReversed$_unit = _slicedToArray(CovertReversed[_unitIndex], 2),
...
var StyledFiberManualRecordIcon = styled$3(function (_ref) {
  _ref.iconSize;
      var rest = _objectWithoutProperties(_ref, _excluded$h);

  return /*#__PURE__*/jsx(FiberManualRecord, _objectSpread$m({}, rest));
}).withConfig({
...
function FormatConnectionStatus(props) {
  ...
  return /*#__PURE__*/jsxs(Flex, {
    ...
    }), /*#__PURE__*/jsx(StyledFiberManualRecordIcon, {
      color: color,
      iconSize: iconSize
    })]
  });
...
FormatConnectionStatus.defaultProps = {
  connectedTitle: /*#__PURE__*/jsx(Trans, {
    id: "Connected"
  }),
  notConnectedTitle: /*#__PURE__*/jsx(Trans, {
    id: "Not connected"
  }),
  variant: 'caption',
  iconSize: 'sm'
...
function GuestRoute(props) {
  ...
  return /*#__PURE__*/jsx(Route, _objectSpread$l({}, props));
}

var StyledIconButton = styled$3(IconButton).withConfig({
...
function IconMessage(props) {
  ...
  return /*#__PURE__*/jsxs(Flex, {
    ...
    gap: 1,
    alignItems: "center",
    children: [icon, /*#__PURE__*/jsx(Typography, _objectSpread$k(_objectSpread$k({
      variant: "body1",
      align: "center"
    }, rest), {}, {
      children: children
...
var StyledIndicator = styled$3(Box).withConfig({
...
var StyledLinearProgress = styled$3(LinearProgress).withConfig({
...
function PlotStatus(props) {
  ...
  return /*#__PURE__*/jsxs(Flex, {
    flexDirection: "column",
    gap: 1,
    children: [progress !== undefined ? /*#__PURE__*/jsxs(Flex, {
      gap: 1,
      alignItems: "center",
      children: [/*#__PURE__*/jsx(StyledLinearProgress, {
        variant: "determinate",
        value: progress * 100,
        color: "secondary"
      }), /*#__PURE__*/jsx(Flex, {
...
function InputBase(props) {
  ...
  return (
    ...
    jsx(Controller, {
      ...
      render: function render(_ref) {
        var field = _ref.field;
        return /*#__PURE__*/jsx(InputBase$1, _objectSpread$j(_objectSpread$j({
          error: !!errorMessage
        }, rest), field));
      }
    })
...
function _objectSpread$i(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys$i(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys$i(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
var StyledChia = styled$3(Chia$1).withConfig({
  displayName: "Logo__StyledChia",
  componentId: "sc-1w61omv-0"
})(["max-width:100%;width:auto;height:auto;"]);
function Logo(props) {
  return /*#__PURE__*/jsx(Box, _objectSpread$i(_objectSpread$i({}, props), {}, {
    children: /*#__PURE__*/jsx(StyledChia, {})
  }));
}
...
function _objectSpread$h(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys$h(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys$h(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
var StyledCircularProgress = styled$3(CircularProgress).withConfig({
...
function Loading(props) {
  ...
  if (children) {
    return /*#__PURE__*/jsxs(Flex, {
      ...
      gap: 1,
      alignItems: "center",
      children: [/*#__PURE__*/jsx(StyledCircularProgress, _objectSpread$h({}, rest)), /*#__PURE__*/jsx(Typography, {
        variant: "body1",
        align: "center",
        children: children
      })]
  ...
  if (center) {
    return /*#__PURE__*/jsx(Flex, {
      ...
      gap: 1,
      alignItems: "center",
      children: /*#__PURE__*/jsx(StyledCircularProgress, _objectSpread$h({}, rest))
    });
  }

  return /*#__PURE__*/jsx(StyledCircularProgress, _objectSpread$h({}, rest));
}
...
var ModeContext = /*#__PURE__*/createContext(undefined);
function ModeProvider(props) {
  ...
  return /*#__PURE__*/jsx(ModeContext.Provider, {
    value: context,
    children: children
  });
}
...
function useMode() {
  var context = useContext(ModeContext);
...
function LocaleToggle(props) {
  ...
  var rest = _extends$1({}, props);

  var _useContext = useContext(LocaleContext),
      locales = _useContext.locales;

  var _useLocale = useLocale(),
      _useLocale2 = _slicedToArray(_useLocale, 2),
  ...
  var localeData = useMemo(function () {
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(Button, _objectSpread$g(_objectSpread$g({
      ...
      "aria-haspopup": "true",
      onClick: handleClick,
      startIcon: /*#__PURE__*/jsx(Translate, {}),
      endIcon: /*#__PURE__*/jsx(ExpandMore, {}),
      ...
      }), /*#__PURE__*/jsx(Divider, {}), locales.map(function (item) {
        return /*#__PURE__*/jsx(MenuItem, {
          onClick: function onClick() {
...
function SettingsApp(props) {
  ...
  function _handleOpenFAQURL() {
    _handleOpenFAQURL = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
      var shell;
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
  ...
  function _handleOpenSendFeedbackURL() {
    _handleOpenSendFeedbackURL = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
      var shell;
  ...
  return /*#__PURE__*/jsxs(Flex, {
    ...
    children: [/*#__PURE__*/jsxs(Flex, {
      ...
      children: [/*#__PURE__*/jsx(SettingsLabel, {
        ...
        fullWidth: true,
        children: [/*#__PURE__*/jsx(Button, {
          startIcon: /*#__PURE__*/jsx(Farming, {}),
          ...
          startIcon: /*#__PURE__*/jsx(AccountBalanceWallet, {}),
      ...
      children: [/*#__PURE__*/jsx(SettingsLabel, {
        ...
        fullWidth: true,
        children: [/*#__PURE__*/jsx(Button, {
          startIcon: /*#__PURE__*/jsx(WbSunny, {}),
          selected: !isDarkMode,
          onClick: function onClick() {
            return disable();
          },
          ...
          startIcon: /*#__PURE__*/jsx(NightsStay, {}),
          selected: isDarkMode,
          onClick: function onClick() {
            return enable();
          },
...
function useAppVersion() {
  ...
  function _getVersion() {
    _getVersion = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
      var currentVersion;
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
...
var StyledRoot$3 = styled$3(Flex).withConfig({
...
function SettingsFooter() {
  ...
  return /*#__PURE__*/jsx(StyledRoot$3, {
    children: /*#__PURE__*/jsxs(Typography, {
      color: "textSecondary",
      variant: "caption",
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(Tooltip, {
      ...
      children: /*#__PURE__*/jsxs(Flex, {
        flexDirection: "column",
        height: "100%",
        children: [/*#__PURE__*/jsx(StyledHeader$1, {
          children: /*#__PURE__*/jsxs(Flex, {
            gap: 1,
            justifyContent: "space-between",
            alignItems: "center",
        ...
        }), /*#__PURE__*/jsx(Divider, {}), /*#__PURE__*/jsx(StyledBody$2, {
          children: children
...
var StyledRoot$2 = styled$3(Flex).withConfig({
  displayName: "LayoutDashboard__StyledRoot",
  componentId: "sc-1nay716-0"
})(["height:100%;"]);
var StyledAppBar = styled$3(AppBar).withConfig({
...
var StyledDrawer = styled$3(Drawer).withConfig({
...
var StyledBody$1 = styled$3(Flex).withConfig({
  displayName: "LayoutDashboard__StyledBody",
  componentId: "sc-1nay716-3"
})(["min-width:0;"]);
var StyledToolbar = styled$3(Toolbar).withConfig({
...
var StyledInlineTypography = styled$3(Typography).withConfig({
...
function LayoutDashboard(props) {
  ...
  return /*#__PURE__*/jsx(StyledRoot$2, {
    children: /*#__PURE__*/jsxs(Suspense, {
      fallback: /*#__PURE__*/jsx(Loading, {
        center: true
      }),
      children: [sidebar ? /*#__PURE__*/jsxs(Fragment, {
        children: [/*#__PURE__*/jsx(StyledAppBar, {
          position: "fixed",
          color: "transparent",
          elevation: 0,
          drawer: true,
              ...
              children: [/*#__PURE__*/jsxs(Flex, {
                ...
                children: [/*#__PURE__*/jsx(Box, {
                  children: /*#__PURE__*/jsxs(Typography, {
                    ...
                    children: [/*#__PURE__*/jsx(Trans, {
                      id: "Wallet"
                    }), "\xA0", fingerprint && /*#__PURE__*/jsx(StyledInlineTypography, {
                      color: "textSecondary",
                      variant: "h5",
        ...
        }), /*#__PURE__*/jsx(StyledDrawer, {
          variant: "permanent",
          children: sidebar
        })]
      }) : /*#__PURE__*/jsx(StyledAppBar, {
        position: "fixed",
        color: "transparent",
        elevation: 0,
        children: /*#__PURE__*/jsx(StyledToolbar, {
      ...
      }), /*#__PURE__*/jsxs(StyledBody$1, {
        flexDirection: "column",
        flexGrow: 1,
        children: [/*#__PURE__*/jsx(ToolbarSpacing, {}), /*#__PURE__*/jsx(Flex, {
          flexDirection: "column",
          gap: 2,
          flexGrow: 1,
          overflow: "auto",
...
var StyledContent = styled$3(Box).withConfig({
...
function DashboardLayout(props) {
  ...
  return /*#__PURE__*/jsxs(StyledRoot$1, {
    children: [sidebar && /*#__PURE__*/jsx(StyledSidebar, {
      children: sidebar
      ...
      children: [/*#__PURE__*/jsx(StyledHeader, {
        ...
        sidebar: !!sidebar,
        header: !!header,
        children: outlet ? /*#__PURE__*/jsx(Outlet$1, {}) : children
      })]
    }) : /*#__PURE__*/jsx(StyledContent, {
      sidebar: !!sidebar,
      children: outlet ? /*#__PURE__*/jsx(Outlet$1, {}) : children
...
function LayoutLoading(props) {
  ...
  return /*#__PURE__*/jsxs(LayoutHero, {
...
function _openFAQURL() {
  _openFAQURL = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
    var shell;
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
function _openSendFeedbackURL() {
  _openSendFeedbackURL = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
    var shell;
    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
var StyledContainer$1 = styled$3(Container).withConfig({
...
var StyledInnerContainer = styled$3(Flex).withConfig({
...
var StyledBody = styled$3(Flex).withConfig({
...
function LayoutMain(props) {
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsxs(StyledInnerContainer, {
      flexDirection: "column",
      children: [bodyHeader, /*#__PURE__*/jsx(StyledContainer$1, {
        maxWidth: "lg",
        children: /*#__PURE__*/jsx(StyledBody, {
          flexDirection: "column",
          gap: 2,
          flexGrow: "1",
          children: outlet ? /*#__PURE__*/jsx(Outlet, {}) : children
    ...
    }), /*#__PURE__*/jsx(LayoutFooter, {})]
  });
}

var StyledRoot = styled$3(Box).withConfig({
  displayName: "LoadingOverlay__StyledRoot",
  componentId: "sc-wwe8k-0"
})(["position:relative;width:100%;"]);
var StyledLoadingContainer = styled$3(Box).withConfig({
...
function LoadingOverlay(props) {
  ...
  return /*#__PURE__*/jsxs(StyledRoot, {
    children: [children, (loading || disabled) && /*#__PURE__*/jsx(StyledLoadingContainer, {
      children: !disabled && /*#__PURE__*/jsx(Loading, {
        center: true
      })
    })]
  });
...
var StyledScrollToBottom = styled$3(ScrollToBottom).withConfig({
  displayName: "Log__StyledScrollToBottom",
  componentId: "sc-113tsy6-0"
})(["width:100%;height:100%;"]);
var StyledPaper = styled$3(Paper).withConfig({
...
function Log(props) {
  ...
  return /*#__PURE__*/jsx(StyledPaper, {
    children: /*#__PURE__*/jsx(StyledScrollToBottom, {
      debug: false,
...
function ModalDialogs() {
  var _useContext = useContext(ModalDialogsContext),
  ...
  return /*#__PURE__*/jsx(Fragment, {
    children: dialogs.map(function (item) {
      ...
      var updatedDialog = /*#__PURE__*/cloneElement(dialog, {
        show: true,
        onClose: handleClose,
        open: true
      });
      return /*#__PURE__*/jsx(Suspense, {
        fallback: /*#__PURE__*/jsx(DialogLoading, {
          onClose: handleClose
        }),
...
function ModalDialogsProvider(props) {
  ...
  function show(dialog) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      setDialogs(function (dialogs) {
        return [].concat(_toConsumableArray(dialogs), [{
          id: id,
          dialog: dialog,
  ...
  return /*#__PURE__*/jsx(ModalDialogsContext.Provider, {
    value: value,
    children: children
  });
}
...
function More(props) {
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    ...
    }), /*#__PURE__*/jsx(Menu, _objectSpread$f(_objectSpread$f({
      anchorEl: anchorEl,
      keepMounted: true,
      onClose: handleClose
    }, rest), {}, {
...
var PersistContext = /*#__PURE__*/createContext(undefined);
...
function Persist(props, ref) {
  ...
  var parentPersistContext = useContext(PersistContext);

  var _useState = useState(defaultValue),
      _useState2 = _slicedToArray(_useState, 1),
      state = _useState2[0];

  var getValue = useCallback(function (defaultValue, namespace) {
  ...
  var setValue = useCallback(function (value, namespace) {
    var currentNamespace = namespace ? "".concat(persistNamespace, ".").concat(namespace) : persistNamespace;
...
var Persist$1 = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(Persist));
...
function NumberFormatCustom(props) {
  ...
  return /*#__PURE__*/jsx(NumberFormat, _objectSpread$e(_objectSpread$e({}, other), {}, {
    getInputRef: inputRef,
    onValueChange: handleChange,
    thousandSeparator: true,
    allowNegative: false,
...
function TextFieldNumber(props) {
  ...
  return /*#__PURE__*/jsxs(FormControl, {
    variant: variant,
    fullWidth: fullWidth,
    children: [/*#__PURE__*/jsx(TextField, _objectSpread$e({
      name: name,
      variant: variant,
      autoComplete: "off",
      InputProps: {
        ...
        endAdornment: currency ? /*#__PURE__*/jsx(InputAdornment, {
          position: "end",
          children: currency
        }) : undefined
      }
...
function PrivateRoute(props) {
  ...
  */
  return /*#__PURE__*/jsx(Route, _objectSpread$d({}, props));
}
...
function _objectSpread$c(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys$c(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys$c(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
var ParseBoolean = /*#__PURE__*/forwardRef(function (props, ref) {
  var onChange = props.onChange,
  ...
  return /*#__PURE__*/jsx(RadioGroup$1, _objectSpread$c({
    onChange: handleChange,
    ref: ref
  }, rest));
});
function RadioGroup(props) {
  ...
  return (
    ...
    jsx(Controller, {
      ...
      render: function render(_ref) {
        var field = _ref.field;
        return _boolean ? /*#__PURE__*/jsx(ParseBoolean, _objectSpread$c(_objectSpread$c({}, field), rest)) : /*#__PURE__*/jsx(RadioGroup$1, _objectSpread$c(_objectSpread$c({}, field), rest));
      }
    })
  );
}
...
function _objectSpread$b(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys$b(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys$b(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
var StyledIframe = styled$3(function (_ref) {
  _ref.isVisible;
      var rest = _objectWithoutProperties(_ref, _excluded$a);

  return /*#__PURE__*/jsx("iframe", _objectSpread$b({}, rest));
}).withConfig({
...
function SandboxedIframe(props) {
  ...
  return /*#__PURE__*/jsx(StyledIframe, {
    srcDoc: srcDoc,
    sandbox: "",
    height: height,
    width: width,
...
var SandboxedIframe$1 = /*#__PURE__*/memo(SandboxedIframe);
...
function Select(props) {
  ...
  var errorMessage = get(errors, controllerName);
  return (
    /*#__PURE__*/
    // @ts-ignore
    jsx(Controller, {
      ...
      render: function render(_ref) {
        var _ref$field = _ref.field,
            ...
            ref = _ref$field.ref;
        return /*#__PURE__*/jsx(Select$1, _objectSpread$a(_objectSpread$a({
...
var StyledListItemIcon = styled$1(ListItemIcon)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  min-width: auto;\n  position: relative;\n  background-color: ", ";\n  border-radius: ", ";\n  width: ", ";\n  height: ", ";\n  border: ", ";\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  transition: border 0.3s ease-in-out;\n\n  &::after {\n    content: \"\";\n    border-radius: ", ";\n    position: absolute;\n    z-index: -1;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    box-shadow: 0px -2px 4px rgba(104, 249, 127, 0.41), 0px 1px 8px rgba(145, 247, 53, 0.45);\n    opacity: 0;\n    transition: opacity 0.3s ease-in-out;\n  }\n\n  svg {\n    color: ", ";\n  }\n"])), function (_ref) {
  var theme = _ref.theme,
      selected = _ref.selected;
...
var StyledListItem = styled$1(ListItem)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding-left: 0;\n  padding-right: 0;\n  padding-top: ", ";\n  padding-bottom: ", ";\n\n  &:hover {\n    background-color: transparent;\n  }\n\n  &:hover ", " {\n    border-color: #4CAF50;\n\n    svg {\n      color: ", " !important;\n    }\n\n    &::after {\n      opacity: 1;\n    }\n  }\n"])), function (_ref8) {
  var theme = _ref8.theme;
  return theme.spacing(1);
}, function (_ref9) {
  var theme = _ref9.theme;
...
var StyledListItemText = styled$1(Typography)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  font-size: ", " !important;\n  font-weight: 500;\n"])), function (_ref11) {
...
function SideBarItem(props) {
  ...
  return /*#__PURE__*/jsx(StyledListItem, _objectSpread$9(_objectSpread$9({
    button: true,
    onClick: function onClick() {
      return handleClick();
    }
    ...
    children: /*#__PURE__*/jsxs(Flex$1, {
      ...
      alignItems: "center",
      gap: 0.5,
      children: [/*#__PURE__*/jsx(StyledListItemIcon, {
        selected: isSelected,
        children: /*#__PURE__*/jsx(Icon, {
          fontSize: "sidebarIcon"
        })
      }), /*#__PURE__*/jsx(StyledListItemText, {
        align: "center",
        children: title
      })]
    })
...
var StyledBackdrop = styled$3(Backdrop).withConfig({
...
var StateIndicatorDot = styled$3(FiberManualRecord).withConfig({
...
var Color$1 = (_Color$1 = {}, _defineProperty(_Color$1, State$1.SUCCESS, StateColor$1.SUCCESS), _defineProperty(_Color$1, State$1.WARNING, StateColor$1.WARNING), _defineProperty(_Color$1, State$1.ERROR, StateColor$1.ERROR), _Color$1);
var StyledFlexContainer = styled$3(function (_ref) {
  _ref.color;
      var rest = _objectWithoutProperties(_ref, _excluded$7);

  return /*#__PURE__*/jsx(Flex, _objectSpread$8({}, rest));
}).withConfig({
...
function StateComponent(props) {
  ...
  return /*#__PURE__*/jsxs(StyledFlexContainer, {
    color: color,
    alignItems: "center",
    gap: gap,
    ...
    children: [/*#__PURE__*/jsx("span", {
      children: children
    }), indicator && /*#__PURE__*/jsx(StateIndicatorDot, {
      color: iconColor
    })]
  });
}
...
var Color = (_Color = {}, _defineProperty(_Color, State$1.SUCCESS, StateColor$1.SUCCESS), _defineProperty(_Color, State$1.WARNING, StateColor$1.WARNING), _defineProperty(_Color, State$1.ERROR, StateColor$1.ERROR), _Color);
var StateTypography = styled$3(function (_ref) {
  _ref.state;
      var rest = _objectWithoutProperties(_ref, _excluded$6);

  return /*#__PURE__*/jsx(Typography, _objectSpread$7({}, rest));
}).withConfig({
...
var StyledTableHead = styled$3(TableHead).withConfig({
...
var StyledTableRow = styled$3(function (_ref2) {
  _ref2.odd;
      var rest = _objectWithoutProperties(_ref2, _excluded$5);

  return /*#__PURE__*/jsx(TableRow, _objectSpread$6({}, rest));
}).withConfig({
...
var StyledExpandedTableRow = styled$3(TableRow).withConfig({
...
var StyledTableCell = styled$3(function (_ref6) {
  _ref6.width;
      _ref6.minWidth;
      _ref6.maxWidth;
      var rest = _objectWithoutProperties(_ref6, _excluded2$1);

  return /*#__PURE__*/jsx(TableCell, _objectSpread$6({}, rest));
}).withConfig({
...
var StyledTableCellContent = styled$3(Box).withConfig({
  displayName: "TableControlled__StyledTableCellContent",
  componentId: "sc-13nrzb8-4"
})(["overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"]);
var StyledExpandedTableCell = styled$3(function (_ref12) {
  _ref12.isExpanded;
      var rest = _objectWithoutProperties(_ref12, _excluded3);
...
var StyledExpandedTableCellContent = styled$3(Box).withConfig({
...
function TableControlled(props) {
  ...
  function handleToggleExpand(rowId) {
    setExpanded(_objectSpread$6(_objectSpread$6({}, expanded), {}, _defineProperty({}, rowId, !expanded[rowId])));
  }
  ...
  var currentCols = useMemo(function () {
    ...
    children: /*#__PURE__*/jsxs(TableContainer, {
      ...
      children: [/*#__PURE__*/jsxs(Table$1, {
        children: [caption && /*#__PURE__*/jsx("caption", {
          children: caption
        }), !hideHeader && /*#__PURE__*/jsx(StyledTableHead, {
          children: /*#__PURE__*/jsx(TableRow, {
            children: currentCols.map(function (col) {
              return /*#__PURE__*/jsx(StyledTableCell, {
                minWidth: col.minWidth,
                maxWidth: col.maxWidth,
                width: col.width,
                children: /*#__PURE__*/jsx(StyledTableCellContent, {
                  children: col.title
                })
              }, col.key);
            })
          ...
          children: preparedRows.map(function (row, rowIndex) {
            ...
            for (var i = 0; i < expandedCellShift; i += 1) {
              expandableCells.push( /*#__PURE__*/jsx(StyledExpandedTableCell, {
                style: {
                  paddingBottom: 0,
                  paddingTop: 0
                },
            ...
            return /*#__PURE__*/jsxs(Fragment$1, {
              children: [/*#__PURE__*/jsx(StyledTableRow, {
                odd: rowIndex % 2 === 1,
                ...
                children: currentCols.map(function (col) {
                  ...
                  return /*#__PURE__*/jsx(StyledTableCell, {
                    ...
                    maxWidth: col.maxWidth,
                    width: col.width,
                    children: tooltipValue ? /*#__PURE__*/jsx(Tooltip$1, {
                      title: tooltipValue,
                      children: /*#__PURE__*/jsx(StyledTableCellContent, {
                        children: value
                      })
                    }) : /*#__PURE__*/jsx(StyledTableCellContent, {
                      children: value
                    })
                  }, col.key);
                })
              }), /*#__PURE__*/jsxs(StyledExpandedTableRow, {
                isExpanded: isExpanded,
                children: [expandableCells, /*#__PURE__*/jsx(StyledExpandedTableCell, {
                  style: {
                    paddingBottom: 0,
                    paddingTop: 0
                  },
                  ...
                  children: /*#__PURE__*/jsx(Collapse, {
                    ...
                    timeout: "auto",
                    unmountOnExit: true,
                    children: /*#__PURE__*/jsx(StyledExpandedTableCellContent, {
      ...
      }), pages && /*#__PURE__*/jsx(TablePagination, {
...
function Table(props) {
  ...
  var _useState3 = useState(defaultPage !== null && defaultPage !== void 0 ? defaultPage : 0),
      _useState4 = _slicedToArray(_useState3, 2),
      page = _useState4[0],
      setPage = _useState4[1];

  var _useState5 = useState(defaultRowsPerPage !== null && defaultRowsPerPage !== void 0 ? defaultRowsPerPage : 10),
  ...
  return /*#__PURE__*/jsx(TableControlled, _objectSpread$5({
    rows: visibleRows,
...
function getMaterialLocale(locale) {
  ...
  return (_materialLocales$mate = materialLocales[materialLocale]) !== null && _materialLocales$mate !== void 0 ? _materialLocales$mate : materialLocales.enUS;
}
var GlobalStyle = createGlobalStyle(["html,body,#root{height:100%;}#root{display:flex;flex-direction:column;}ul .MuiBox-root{outline:none;}"]);
function ThemeProvider(props) {
  ...
  var finallTheme = useMemo(function () {
    var localisedTheme = getMaterialLocale(locale);
    return createTheme$1(theme, localisedTheme);
  }, [theme, locale]);
  return /*#__PURE__*/jsx(ThemeProvider$1, {
    ...
    children: /*#__PURE__*/jsx(ThemeProvider$2, {
      ...
      children: /*#__PURE__*/jsxs(Fragment, {
        children: [/*#__PURE__*/jsx(CssBaseline, {}), global && /*#__PURE__*/jsx(GlobalStyle, {}), fonts && /*#__PURE__*/jsx(Fonts, {}), children]
      })
    })
  });
}
...
function TooltipTypography(props) {
  ...
  return /*#__PURE__*/jsxs(Flex, {
    alignItems: "center",
    gap: 1,
    children: [/*#__PURE__*/jsx(Typography, _objectSpread$4({}, rest)), /*#__PURE__*/jsx(TooltipIcon, {
      children: title
    })]
  });
}
...
function Truncate(props) {
  ...
  if (tooltip) {
    return /*#__PURE__*/jsx(Tooltip, {
      title: children,
      copyToClipboard: copyToClipboard,
      children: /*#__PURE__*/jsx(Typography, _objectSpread$3(_objectSpread$3({}, ValueProps), {}, {
        children: value
      }))
    });
  }

  return /*#__PURE__*/jsx(Typography, _objectSpread$3(_objectSpread$3({}, ValueProps), {}, {
    children: value
  }));
}
...
function UnitFormat(props) {
  ...
  var currencyCode = useCurrencyCode();
  return /*#__PURE__*/jsx(StateTypography, _objectSpread$2(_objectSpread$2({
    variant: variant,
    state: state
  }, rest), {}, {
...
var UnitAliases = (_UnitAliases = {}, _defineProperty(_UnitAliases, Unit$1.CHIA, ['ch', 'chia', 'xch']), _defineProperty(_UnitAliases, Unit$1.MOJO, ['mj', 'mojo', 'mojos']), _defineProperty(_UnitAliases, Unit$1.CAT, ['cat', 'cc', 'colouredcoin']), _UnitAliases);
...
var MOJO_PER_CHIA = new BigNumber('1000000000000');
...
function sumPoints(points) {
  ...
  return (_sumBy = sumBy(points, function (point) {
    return point[1];
...
function _getPoolInfo() {
  _getPoolInfo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(poolUrl) {
    var url, response;
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
function getTransactionResult(transaction) {
  if (!transaction || !transaction.sentTo || !transaction.sentTo.length) {
    return {
      message:
      /*i18n*/
      i18n._("Transaction has not been sent to node yet"),
      success: true
    };
  ...
  if (hasSuccess) {
    return {
      message:
      /*i18n*/
      i18n._("Transaction has successfully been sent to a full node and included in the mempool."),
      success: true
    };
  ...
  if (pendingNodeResponse) {
    return {
      message:
      /*i18n*/
      i18n._("Transaction has sent to a full node and is pending inclusion into the mempool. {0}", {
...
function validAddress(address, allowedPrefixes) {
  var response = decodeBech32m(address);
...
function usePersistState(defaultValue, namespace) {
  var persistContext = useContext(PersistContext);
...
function useSerializedNavigationState() {
  var originalNavigate = useNavigate();
  var location = useLocation();

  function wrappedNavigate(path, options) {
    if (options !== null && options !== void 0 && options.state) {
      var state = JSONbig.stringify(options === null || options === void 0 ? void 0 : options.state);
...
function useShowSaveDialog() {
  ...
  function _handleShowSaveDialog() {
    _handleShowSaveDialog = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
...
function useTrans() {
  ...
  var handleTranslate = useCallback(function (messageId, values, options) {
...
function useValidateChangePassphraseParams() {
  var _useGetKeyringStatusQ = useGetKeyringStatusQuery(),
  ...
  function _validateChangePassphraseParams() {
    _validateChangePassphraseParams = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(currentPassphrase, newPassphrase, confirmationPassphrase) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              throw new Error(
              /*i18n*/
              i18n._("The provided passphrase and confirmation do not match"));
            ...
            case 12:
              ...
              throw new Error(
              /*i18n*/
              i18n._("{minPassphraseLength, plural, one {Passphrases must be at least # character in length} other {Passphrases must be at least # characters in length}}", {
            ...
            case 16:
              ...
              throw new Error(
              /*i18n*/
              i18n._("New passphrase is the same as your current passphrase"));
            ...
            case 20:
              ...
              if (currentPassphrase === null) {
                alertTitle = /*#__PURE__*/jsx(Trans, {
                  id: "Skip Passphrase Protection"
                });
                buttonTitle = /*#__PURE__*/jsx(Trans, {
                  id: "Skip"
                });
            ...
            case 30:
              ...
              _context.t0 = _context["catch"](0);
              _context.next = 34;
              return openDialog( /*#__PURE__*/jsx(AlertDialog, {
...
var theme = createTheme$1(greyTheme);
var theme$1 = deepmerge(greyTheme, {
  palette: {
    background: {
      "default": '#fafafa'
    },
...
var dark = createTheme$1(deepmerge(theme$1, {
  palette: {
    background: {
      "default": '#212121',
      paper: '#333333'
...
var light = createTheme$1(theme$1);
...
var StyledTypographyDD = styled$3(Typography).withConfig({
...
function SelectKeyDetailDialog(props) {
  ...
  var _useGetPrivateKeyQuer = useGetPrivateKeyQuery({
    fingerprint: fingerprint
      ...
      _objectWithoutProperties(_useGetPrivateKeyQuer, _excluded2);

  if (isLoading) {
    return /*#__PURE__*/jsx(AlertDialog, _objectSpread(_objectSpread({
      title: /*#__PURE__*/jsx(Trans, {
  ...
  return /*#__PURE__*/jsx(AlertDialog, _objectSpread(_objectSpread({
    ...
    children: /*#__PURE__*/jsxs(Grid, {
      ...
      children: [/*#__PURE__*/jsxs(Grid, {
        ...
        }), /*#__PURE__*/jsx(StyledTypographyDD, {
          component: "dd",
          variant: "body2",
        ...
        item: true,
        children: privateKey.seed ? /*#__PURE__*/jsxs(Fragment, {
          children: [/*#__PURE__*/jsx(Typography, {
            component: "dt",
            variant: "subtitle2",
            children: /*#__PURE__*/jsx(Trans, {
...
function useKeyringMigrationPrompt() {
  var _useSkipMigration = useSkipMigration(),
      _useSkipMigration2 = _slicedToArray(_useSkipMigration, 2);
  ...
  function _promptForKeyringMigration() {
    _promptForKeyringMigration = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
      var beginMigration;
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
...
var StyledFingerprintListItem = styled$3(ListItem).withConfig({
...
function SelectKeyItem(props) {
  ...
  var _useDeleteKeyMutation = useDeleteKeyMutation(),
      _useDeleteKeyMutation2 = _slicedToArray(_useDeleteKeyMutation, 1),
      deleteKey = _useDeleteKeyMutation2[0];

  var _useCheckDeleteKeyMut = useCheckDeleteKeyMutation(),
      _useCheckDeleteKeyMut2 = _slicedToArray(_useCheckDeleteKeyMut, 1),
      checkDeleteKey = _useCheckDeleteKeyMut2[0];

  var _useSkipMigration = useSkipMigration(),
      _useSkipMigration2 = _slicedToArray(_useSkipMigration, 1),
      skippedMigration = _useSkipMigration2[0];

  var _useKeyringMigrationP = useKeyringMigrationPrompt(),
      _useKeyringMigrationP2 = _slicedToArray(_useKeyringMigrationP, 1),
  ...
  function handleShowKey(event) {
    event.stopPropagation();
    openDialog( /*#__PURE__*/jsx(SelectKeyDetailDialog, {
      fingerprint: fingerprint
    }));
  }
  ...
  function _handleDeletePrivateKey() {
    _handleDeletePrivateKey = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(event) {
          ...
          switch (_context3.prev = _context3.next) {
            case 0:
              _handleKeyringMutator = function _handleKeyringMutator3() {
                _handleKeyringMutator = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
                  return _regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
            ...
            case 10:
              ...
              _context3.next = 17;
              return openDialog( /*#__PURE__*/jsxs(ConfirmDialog, {
                title: /*#__PURE__*/jsx(Trans, {
                ...
                children: [usedForFarmerRewards && /*#__PURE__*/jsx(Alert, {
                  severity: "warning",
                  children: /*#__PURE__*/jsx(Trans, {
                ...
                }), usedForPoolRewards && /*#__PURE__*/jsx(Alert, {
                  severity: "warning",
                  children: /*#__PURE__*/jsx(Trans, {
                ...
                }), walletBalance && /*#__PURE__*/jsx(Alert, {
                  severity: "warning",
                  children: /*#__PURE__*/jsx(Trans, {
...
var StyledContainer = styled$3(Container).withConfig({
...
function SelectKey() {
  ...
  var _useDeleteAllKeysMuta = useDeleteAllKeysMutation(),
      _useDeleteAllKeysMuta2 = _slicedToArray(_useDeleteAllKeysMuta, 1),
      deleteAllKeys = _useDeleteAllKeysMuta2[0];

  var _useLogInAndSkipImpor = useLogInAndSkipImportMutation(),
      _useLogInAndSkipImpor2 = _slicedToArray(_useLogInAndSkipImpor, 2),
      logIn = _useLogInAndSkipImpor2[0],
      isLoadingLogIn = _useLogInAndSkipImpor2[1].isLoading;

  var _useGetPublicKeysQuer = useGetPublicKeysQuery(),
  ...
  function _handleSelect() {
    _handleSelect = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(fingerprint) {
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
  ...
  function _handleDeleteAllKeys() {
    _handleDeleteAllKeys = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
  ...
  function _handleKeyringMutator() {
    _handleKeyringMutator = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3() {
      return _regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
  ...
  function _handleNavigationIfKeyringIsMutable() {
    _handleNavigationIfKeyringIsMutable = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(url) {
      var canModifyKeyring;
  ...
  return /*#__PURE__*/jsx(StyledContainer, {
    ...
    children: /*#__PURE__*/jsxs(Flex, {
      ...
      children: [/*#__PURE__*/jsx(Logo, {
        width: 130
      }), isLoadingPublicKeys ? /*#__PURE__*/jsx(Loading, {
        center: true,
        children: /*#__PURE__*/jsx(Trans, {
      ...
      }) : hasFingerprints ? /*#__PURE__*/jsx(Typography, {
        variant: "h5",
        component: "h1",
        children: /*#__PURE__*/jsx(Trans, {
          id: "Select Key"
        ...
        alignItems: "stretch",
        alignSelf: "stretch",
        children: [hasFingerprints && /*#__PURE__*/jsx(Card$1, {
          children: /*#__PURE__*/jsx(List, {
            children: publicKeyFingerprints.map(function (fingerprint) {
              return /*#__PURE__*/jsx(SelectKeyItem, {
                fingerprint: fingerprint,
...
var FileSizeError = /*#__PURE__*/function (_Error) {
  _inherits(FileSizeError, _Error);
  ...
  function FileSizeError() {
    ...
    _defineProperty(_assertThisInitialized(_this), "code", 'FILE_SIZE_ERROR');

    return _this;
  }

  return _createClass(FileSizeError);
}( /*#__PURE__*/_wrapNativeSuper(Error));

export { Accordion, Address, AdvancedOptions, AlertDialog, Amount, AspectRatio, Autocomplete, Back, Button, ButtonLoading, ButtonSelected, Card, CardHero, CardKeyValue, CardListItem, CardSimple, CardStep, Checkbox, ConfirmDialog, CopyToClipboard, DarkModeToggle, DialogActions, Dropdown, DropdownActions$1 as DropdownActions, DropdownIconButton, Dropzone, ErrorBoundary, Fee, FileSizeError, Flex, Fonts, Form, FormBackButton, FormatBytes, FormatConnectionStatus, FormatLargeNumber, GuestRoute, Heading, StyledIconButton as IconButton, IconMessage, PlotStatus as Indicator, InputBase, LayoutDashboard, DashboardLayout as LayoutDashboardSub, LayoutHero, LayoutLoading, LayoutMain, Link, Loading, LoadingOverlay, LocaleContext, LocaleProvider, LocaleToggle, Log, Logo, ModalDialogs, ModalDialogsProvider, Mode$1 as Mode, ModeProvider, More, Persist$1 as Persist, PrivateRoute, RadioGroup, SandboxedIframe$1 as SandboxedIframe, Select, SelectKey, SettingsApp, SettingsLabel, SideBarItem, Spacer, Spinner, State$1 as State, StateColor$1 as StateColor, StateComponent as StateIndicator, StateIndicatorDot, StateTypography, Suspender, Table, TableControlled, TextField, TextFieldNumber, ThemeProvider, ToolbarSpacing, Tooltip, TooltipIcon, TooltipTypography, Truncate, Unit$1 as Unit, UnitAliases, UnitFormat, UnitValue, activateLocale, blockHeightToTimestamp, calculateBaseFarmerReward, calculatePoolReward, catToMojo, chiaFormatter, chiaToMojo, dark, getPercentPointsSuccessfull, getPoolInfo, getTransactionResult, isWindows, light, index as locales, mojoToCAT, mojoToCATLocaleString, mojoToChia, mojoToChiaLocaleString, sleep, truncateValue, useColorModeValue, useCurrencyCode, useDarkMode, useIsSimulator, useLocalStorage, useLocale, useMode, useOpenDialog, useOpenExternal, usePersist, usePersistState, useSerializedNavigationState, useShowDebugInformation, useShowError, useShowSaveDialog, useSkipMigration, useTrans, useValidateChangePassphraseParams, validAddress };
