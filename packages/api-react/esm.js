...
import Client, { FullNode, Farmer, Daemon, optionsForPlotter, defaultsForPlotter, Harvester, Plotter, Wallet, CAT, WalletType, Pool, DID, toBech32m, NFT, ServiceName } from '@chia/api';
...
function _getClientInstance() {
  _getClientInstance = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(api) {
    var config;
...
function _getServiceInstance() {
  _getServiceInstance = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(api, ServiceClass) {
...
function chiaLazyBaseQuery() {
  ...
  return /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(_ref, api) {
      ...
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 17:
              _context.next = 19;
              return instance[command].apply(instance, _toConsumableArray(args));
...
function onCacheEntryAddedInvalidate(rtkQuery, invalidates) {
  return /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(args, api) {
          ...
          switch (_context3.prev = _context3.next) {
            ...
            case 5:
              ...
              return Promise.all(invalidates.map( /*#__PURE__*/function () {
                var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(invalidate) {
    ...
    return {
      ...
      getFullNodeConnections: build.query({
        ...
        providesTags: function providesTags(connections) {
          return connections ? [].concat(_toConsumableArray(connections.map(function (_ref2) {
...
function useGetLatestBlocksQuery() {
  ...
  var _useGetBlockchainStat = useGetBlockchainStateQuery$1(),
      ...
      rest = _objectWithoutProperties(_useGetBlockchainStat, _excluded$5);

  var peakHeight = get(state, 'peak.height');
  ...
  return _objectSpread$9({
    isLoading: isLoading,
    data: blocks ? _toConsumableArray(blocks).reverse() : blocks
  }, rest);
}
...
function getLatestTimestamp(blocks, lastPeekTimestamp) {
  ...
  return timestampNumbers.length ? Math.max.apply(Math, _toConsumableArray(timestampNumbers)) : undefined;
}

function useGetLatestPeakTimestampQuery() {
  var latestPeakTimestamp = useRef();
  ...
  var _useGetLatestBlocksQu = useGetLatestBlocksQuery(10),
      ...
      rest = _objectWithoutProperties(_useGetLatestBlocksQu, _excluded$4);

  var newPeakTimestamp = useMemo(function () {
    ...
    return {
      ...
      getHarvesters: build.query({
        ...
        providesTags: function providesTags(harvesters) {
          return harvesters ? [].concat(_toConsumableArray(harvesters.map(function (_ref) {
            var id = _ref.id;
            return {
              type: 'Harvesters',
              id: id
      ...
      getHarvestersSummary: build.query({
        ...
        providesTags: function providesTags(harvesters) {
          return harvesters ? [].concat(_toConsumableArray(harvesters.map(function (_ref2) {
            var id = _ref2.id;
            return {
      ...
      getHarvesterPlotsValid: build.query({
        ...
        providesTags: function providesTags(plots) {
          return plots ? [].concat(_toConsumableArray(plots.map(function (_ref4) {
      ...
      getHarvesterPlotsInvalid: build.query({
        ...
        providesTags: function providesTags(plots) {
          return plots ? [].concat(_toConsumableArray(plots.map(function (filename) {
            return {
      ...
      getFarmerConnections: build.query({
        ...
        providesTags: function providesTags(connections) {
          return connections ? [].concat(_toConsumableArray(connections.map(function (_ref10) {
      ...
      getSignagePoints: build.query({
        ...
        providesTags: function providesTags(signagePoints) {
          return signagePoints ? [].concat(_toConsumableArray(signagePoints.map(function (_ref15) {
      ...
      getPoolState: build.query({
        ...
        providesTags: function providesTags(poolsList) {
          return poolsList ? [].concat(_toConsumableArray(poolsList.map(function (_ref16) {
...
function useGetFarmerFullNodeConnectionsQuery() {
  var _useGetFarmerConnecti = useGetFarmerConnectionsQuery$1({}, {
    pollingInterval: 10000
      ...
      rest = _objectWithoutProperties(_useGetFarmerConnecti, _excluded$3);
...
function useGetHarvesterConnectionsQuery() {
  var _useGetFarmerConnecti = useGetFarmerConnectionsQuery$1({}, {
    pollingInterval: 10000
      ...
      connections = _useGetFarmerConnecti.data,
      rest = _objectWithoutProperties(_useGetFarmerConnecti, _excluded$2);
...
function useGetHarvesterQuery(_ref) {
  ...
  var harvester = useMemo(function () {
  ...
  endpoints: function endpoints(build) {
    return {
      ...
      getKeyringStatus: build.query({
        ...
        transformResponse: function transformResponse(response) {
          response.status;
              var rest = _objectWithoutProperties(response, _excluded$1);
        ...
        onCacheEntryAdded: onCacheEntryAddedInvalidate(baseQuery, [{
          ...
          onUpdate: function onUpdate(draft, data) {
            ...
            data.status;
                var rest = _objectWithoutProperties(data, _excluded2$1); // assign new items
  ...
  endpoints: function endpoints(build) {
    return {
      ...
      getPlots: build.query({
        ...
        providesTags: function providesTags(plots) {
          return plots ? [].concat(_toConsumableArray(plots.map(function (_ref) {
      ...
      getPlotDirectories: build.query({
        ...
        providesTags: function providesTags(directories) {
          return directories ? [].concat(_toConsumableArray(directories.map(function (directory) {
            return {
...
function removeOldPoints(points) {
  ...
  return points === null || points === void 0 ? void 0 : points.filter(function (point) {
    var _point = _slicedToArray(point, 1),
        timestamp = _point[0];
    ...
    return {
      ...
      getWallets: build.query({
        ...
        */
        ...
        providesTags: function providesTags(result) {
          return result ? [].concat(_toConsumableArray(result.map(function (_ref2) {
            var id = _ref2.id;
            return {
              type: 'Wallets',
              id: id
      ...
      getWalletBalance: build.query({
        ...
        transformResponse: function transformResponse(response) {
          ...
          var pendingBalance = new BigNumber(unconfirmedWalletBalance).minus(confirmedWalletBalance);
          var pendingTotalBalance = new BigNumber(confirmedWalletBalance).plus(pendingBalance);
                ...
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    return new Promise( /*#__PURE__*/function () {
                      var _ref14 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(resolve, reject) {
                          ...
                          while (1) {
                            switch (_context3.prev = _context3.next) {
                              ...
                              case 8:
                                ...
                                _objectWithoutProperties(_yield$fetchWithBQ4, _excluded);
      ...
      getPublicKeys: build.query({
        ...
        providesTags: function providesTags(keys) {
          return keys ? [].concat(_toConsumableArray(keys.map(function (key) {
            return {
              type: 'Keys',
              id: key
            };
      ...
      getTransactions: build.query({
        ...
        providesTags: function providesTags(result) {
          return result ? [].concat(_toConsumableArray(result.map(function (_ref27) {
      ...
      getWalletConnections: build.query({
        ...
        providesTags: function providesTags(connections) {
          return connections ? [].concat(_toConsumableArray(connections.map(function (_ref36) {
      ...
      getAllOffers: build.query({
        ...
        providesTags: function providesTags(result) {
          return result ? [].concat(_toConsumableArray(result.map(function (_ref42) {
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
                    ...
                    _context6.next = 5;
                    return new Promise( /*#__PURE__*/function () {
                      var _ref53 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(resolve, reject) {
                          ...
                          while (1) {
                            switch (_context5.prev = _context5.next) {
                              ...
                              case 8:
                                ...
                                _objectWithoutProperties(_yield$fetchWithBQ5, _excluded2);
              ...
              while (1) {
                switch (_context12.prev = _context12.next) {
                  case 0:
                    ...
                    _context12.prev = 1;
                    _context12.next = 4;
                    return Promise.all([_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8() {
                  ...
                  case 10:
                    ...
                    poolWallets = (_wallets$filter = wallets === null || wallets === void 0 ? void 0 : wallets.filter(function (wallet) {
                      return wallet.type === WalletType.POOLING_WALLET;
                    })) !== null && _wallets$filter !== void 0 ? _wallets$filter : [];
                    _context12.t0 = Promise;
                    _context12.next = 14;
                    return Promise.all(poolWallets.map( /*#__PURE__*/function () {
                      var _ref58 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee10(wallet) {
                  ...
                  case 14:
                    ...
                    _context12.next = 17;
                    return Promise.all(poolWallets.map( /*#__PURE__*/function () {
                      var _ref59 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee11(wallet) {
      ...
      getDIDs: build.query({
                ...
                switch (_context14.prev = _context14.next) {
                  ...
                  case 11:
                    didWallets = wallets.filter(function (wallet) {
                      return wallet.type === WalletType.DECENTRALIZED_ID;
                    });
                    _context14.next = 14;
                    return Promise.all(didWallets.map( /*#__PURE__*/function () {
                      var _ref71 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee13(wallet) {
        ...
        providesTags: function providesTags(result) {
          return result ? [].concat(_toConsumableArray(result.map(function (_ref72) {
            var id = _ref72.id;
            return {
              type: 'DIDWallet',
              id: id
      ...
      getNFTs: build.query({
                ...
                switch (_context16.prev = _context16.next) {
                  case 0:
                    ...
                    return Promise.all(args.walletIds.map( /*#__PURE__*/function () {
                      var _ref79 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee15(walletId) {
                          ...
                          while (1) {
                            switch (_context15.prev = _context15.next) {
                              ...
                              case 7:
                                ...
                                return _context15.abrupt("return", _defineProperty({}, walletId, updatedNFTs));
        ...
        providesTags: function providesTags(nftsByWalletId, _error) {
          return nftsByWalletId ? [].concat(_toConsumableArray(Object.entries(nftsByWalletId).flatMap(function (_ref83) {
      ...
      getNFTWalletsWithDIDs: build.query({
        ...
        providesTags: function providesTags(result, _error) {
          return result ? [].concat(_toConsumableArray(result.map(function (_ref85) {
...
function useGetNFTWallets() {
  ...
  var nftWallets = useMemo(function () {
    if (!data || isLoading) {
      return [];
    }

    return data.filter(function (wallet) {
      return wallet.type === WalletType.NFT;
    });
  }, [data]);
  return {
    wallets: nftWallets,
...
function createStore(options) {
  ...
  return configureStore(_objectSpread$1({
    reducer: (_reducer = {}, _defineProperty(_reducer, api.reducerPath, api.reducer), _defineProperty(_reducer, "api", apiReducer), _reducer),
...
function useNFTMetadata(_ref) {
  ...
  return {
    ...
    metadata: {
      ...
      contractAddress: "xch".concat(randomBytes(20).toString('hex')),
...
function useService(service, options) {
  ...
  var _useClientStartServic = useClientStartServiceMutation$1(),
      _useClientStartServic2 = _slicedToArray(_useClientStartServic, 1),
      startService = _useClientStartServic2[0];

  var _useStopServiceMutati = useStopServiceMutation$1(),
      _useStopServiceMutati2 = _slicedToArray(_useStopServiceMutati, 1),
  ...
  function _handleStart() {
    _handleStart = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
  ...
  function _handleStop() {
    _handleStop = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
      return _regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
...
function useThrottleQuery(queryHook, variables, options) {
  ...
  var refState = useRef();
  var processUpdate = useCallback(throttle(function () {
    return forceUpdate();
  }, wait, {
    leading: leading,
    trailing: trailing
...
function useMonitorServices(services) {
  ...
  var walletState = useService(ServiceName.WALLET, getServiceOptions(ServiceName.WALLET, services, options));
  var fullNodeState = useService(ServiceName.FULL_NODE, getServiceOptions(ServiceName.FULL_NODE, services, options));
  var farmerState = useService(ServiceName.FARMER, getServiceOptions(ServiceName.FARMER, services, options));
  var harvesterState = useService(ServiceName.HARVESTER, getServiceOptions(ServiceName.HARVESTER, services, options));
  var simulatorState = useService(ServiceName.SIMULATOR, getServiceOptions(ServiceName.SIMULATOR, services, options));
  var plotterState = useService(ServiceName.PLOTTER, getServiceOptions(ServiceName.PLOTTER, services, options));
  var timelordState = useService(ServiceName.TIMELORD, getServiceOptions(ServiceName.TIMELORD, services, options));
  var introducerState = useService(ServiceName.INTRODUCER, getServiceOptions(ServiceName.INTRODUCER, services, options));
...
function useGetTotalHarvestersSummaryQuery() {
  ...
  var _useMemo = useMemo(function () {
    var duplicates = new BigNumber(0);
    var failedToOpenFilenames = new BigNumber(0);
    var noKeyFilenames = new BigNumber(0);
    var plots = new BigNumber(0);
    var plotsProcessed = new BigNumber(0);
    var totalPlotSize = new BigNumber(0);
    var plotFilesTotal = new BigNumber(0);
...
export { api$1 as api, api as chiaApi, clientApi, createStore, daemonApi, farmerApi, fullNodeApi, harvesterApi, plotterApi, store, useAddCATTokenMutation, useAddKeyMutation, useAddPlotDirectoryMutation, useAppDispatch, useCancelOfferMutation, useCheckDeleteKeyMutation, useCheckOfferValidityMutation, useClientStartServiceMutation, useCloseFarmerConnectionMutation, useCloseFullNodeConnectionMutation, useCloseMutation, useCloseWalletConnectionMutation, useCreateBackupMutation, useCreateCATWalletForExistingMutation, useCreateNewCATWalletMutation, useCreateNewDIDWalletMutation, useCreateNewPoolWalletMutation, useCreateNewWalletMutation, useCreateOfferForIdsMutation, useDaemonPingQuery, useDeleteAllKeysMutation, useDeleteKeyMutation, useDeletePlotMutation, useDeleteUnconfirmedTransactionsMutation, useExtendDerivationIndexMutation, useFarmBlockMutation, useFarmerPingQuery, useFullNodePingQuery, useGenerateMnemonicMutation, useGetAllOffersQuery, useGetBackupInfoByFingerprintQuery, useGetBackupInfoByWordsQuery, useGetBackupInfoQuery, useGetBlockQuery, useGetBlockRecordQuery, useGetBlockRecordsQuery, useGetBlockchainStateQuery, useGetCATAssetIdQuery, useGetCATNameQuery, useGetCatListQuery, useGetCurrentAddressQuery, useGetCurrentDerivationIndexQuery, useGetDIDCurrentCoinInfoQuery, useGetDIDInformationNeededForRecoveryQuery, useGetDIDNameQuery, useGetDIDPubKeyQuery, useGetDIDQuery, useGetDIDRecoveryListQuery, useGetDIDsQuery, useGetFarmedAmountQuery, useGetFarmerConnectionsQuery, useGetFarmerFullNodeConnectionsQuery, useGetFarmingInfoQuery, useGetFullNodeConnectionsQuery, useGetHarvesterConnectionsQuery, useGetHarvesterPlotsDuplicatesQuery, useGetHarvesterPlotsInvalidQuery, useGetHarvesterPlotsKeysMissingQuery, useGetHarvesterPlotsValidQuery, useGetHarvesterQuery, useGetHarvesterStats, useGetHarvestersQuery, useGetHarvestersSummaryQuery, useGetHeightInfoQuery, useGetKeyringStatusQuery, useGetLatestBlocksQuery, useGetLatestPeakTimestampQuery, useGetLoggedInFingerprintQuery, useGetNFTInfoQuery, useGetNFTWallets, useGetNFTWalletsWithDIDsQuery, useGetNFTsQuery, useGetNetworkInfoQuery, useGetNextAddressMutation, useGetOfferDataMutation, useGetOfferRecordMutation, useGetOfferSummaryMutation, useGetOffersCountQuery, useGetPlotDirectoriesQuery, useGetPlotNFTsQuery, useGetPlotQueueQuery, useGetPlotsQuery, useGetPlottersQuery, useGetPoolLoginLinkQuery, useGetPoolStateQuery, useGetPrivateKeyQuery, useGetPublicKeysQuery, useGetPwStatusQuery, useGetRewardTargetsQuery, useGetSignagePointsQuery, useGetStateQuery, useGetStrayCatsQuery, useGetSyncStatusQuery, useGetThrottlePlotQueueQuery, useGetTotalHarvestersSummaryQuery, useGetTransactionQuery, useGetTransactionsCountQuery, useGetTransactionsQuery, useGetUnfinishedBlockHeadersQuery, useGetWalletBalanceQuery, useGetWalletConnectionsQuery, useGetWalletsQuery, useHarvesterPingQuery, useIsServiceRunningQuery, useLogInAndImportBackupMutation, useLogInAndSkipImportMutation, useLogInMutation, useLogout, useMigrateKeyringMutation, useNFTMetadata, useOpenFarmerConnectionMutation, useOpenFullNodeConnectionMutation, useOpenWalletConnectionMutation, usePwAbsorbRewardsMutation, usePwJoinPoolMutation, usePwSelfPoolMutation, useReceiveNFTMutation, useRefreshPlotsMutation, useRemoveKeyringPassphraseMutation, useRemovePlotDirectoryMutation, useSendTransactionMutation, useService, useMonitorServices as useServices, useSetCATNameMutation, useSetDIDNameMutation, useSetKeyringPassphraseMutation, useSetNFTDIDMutation, useSetNFTStatusMutation, useSetPayoutInstructionsMutation, useSetRewardTargetsMutation, useSpendCATMutation, useStartPlottingMutation, useStartServiceMutation, useStopPlottingMutation, useStopServiceMutation, useTakeOfferMutation, useThrottleQuery, useTransferNFTMutation, useTypedSelector, useUnlockKeyringMutation, useUpdateDIDRecoveryIdsQuery, useWalletPingQuery, walletApi };
